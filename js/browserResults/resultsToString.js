...
<tbody>
  ...
  ${tableStr.row3val(
    ...
    validMod ? round(modResult.debug_data.spGrav, 2) : "",
    validMod
  )}
  <tr>
    <td class="tg-simple">▪ Calor absorbido estimado, ${unit.heat_flow(
      0,
      0,
      0,
      true
  ...
  ${tableStr.row3(
    "Humedad relativa, %",
    baseResult.debug_data,
    validMod ? modResult.debug_data : {},
    "humidity_%",
    validMod,
    1,
    0
  ...
  <tr>
    <td class="tg-simple">Calor específico Cp (T comb), ${unit.cp(
      0,
      0,
      0,
      true
  ...
  ${tableStr.emptyRow3}
  ${tableStr.fullRow3(
    `▪ Distribución del calor absorbido, ${unit.heat_flow(0, 0, 0, true)}`
  )}
  <tr>
