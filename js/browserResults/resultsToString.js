...
Datos de entrada
  ...
  Emisiones de CO2: ${
        round(((result_obj.products["CO2"] * 44.01) /
               result_obj.flows["fuel_MW"]) *
                  result_obj.rad_result.m_fuel * (1e-3 * 24 * 365),
              0)} ton/año
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-simple">${validMod ? modOpt.mFluid.toLocaleString() : ""}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-simple">${
      validMod ? round(modResult.debug_data["humidity_%"], 0) : ""}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-simple">${
      unit["energy/mass"](baseResult.flows.NCV_val, 1, true)}</td>
    <td class="tg-simple">${
  ...
  <tr>
    <td class="tg-simple">Poder Calorífico Bruto (GCV), ${
      unit["energy/mass"](0, 0, 0, true)}</td>
    <td class="tg-simple">${
      unit["energy/mass"](baseResult.flows.GCV_val, 1, true)}</td>
    <td class="tg-simple">${
  ...
  <tr>
    ...
    <td class="tg-simple">${
      unit.mass_flow(baseResult.rad_result.m_fuel, 0, true)}</td>
    <td class="tg-simple">${
      validMod ? unit.mass_flow(modResult.rad_result.m_fuel, 0, true) : ""}</td>
  </tr>
  <tr>
    <td class="tg-simple">· Aire</td>
    <td class="tg-simple">${
      unit.mass_flow(baseResult.rad_result.m_air, 0, true)}</td>
    <td class="tg-simple">${
      validMod ? unit.mass_flow(modResult.rad_result.m_air, 0, true) : ""}</td>
  </tr>
  <tr>
    <td class="tg-simple">· Gases de combustión</td>
    <td class="tg-simple">${
      unit.mass_flow(baseResult.rad_result.m_flue, 0, true)}</td>
    <td class="tg-simple">${
      validMod ? unit.mass_flow(modResult.rad_result.m_flue, 0, true) : ""}</td>
  </tr>
  ...
  <tr>
    ...
    <td class="tg-simple">${
      unit.tempC(baseResult.conv_result.t_fin, 0, true)}</td>
    <td class="tg-simple">${
      validMod ? unit.tempC(modResult.conv_result.t_fin, 0, true) : ""}</td>
  </tr>
  <tr>
    ...
    <td class="tg-simple">${
      round(
          ((baseResult.products["CO2"] * 44.01) / baseResult.flows["fuel_MW"]) *
              baseResult.rad_result.m_fuel * (1e-3 * 24 * 365),
          0)}</td>
    <td class="tg-simple">${
      validMod ? round(((modResult.products["CO2"] * 44.01) /
                        modResult.flows["fuel_MW"]) *
                           modResult.rad_result.m_fuel * (1e-3 * 24 * 365),
                       0)
               : ""}</td>
  </tr>
  <tr><td colspan="3"></td></tr>
