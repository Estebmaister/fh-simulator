...
const graphicData =
    (comb, fuel, opt) => {
      ...
      if (initVar < 0)
        initVar = 0;
      savedLogger.info(`Var: ${graphVar}, centerValue: ${
          opt[graphVar]}, range: ${range}, points: ${points}`);
      for (let index = 0; index < points; index++) {
        ...
        browserResult[index] = {
          ...
          co2_emiss :
              Math.round(1e2 * runResult.products["CO2"] *
