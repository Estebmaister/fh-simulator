      ...
      566: (t, e, s) => {
        ...
        t.exports = {
          graphicData: (t, e, s) => {
            ...
            let c,
              _,
              d = JSON.parse(localStorage.getItem(u));
            if (
              (d &&
            ...
            d || (d = {}),
              (d[`${window.location.search}`] = i),
              (d.time = { date: Date.now() }),
        ...
        t.exports = {
          ...
          stringCompactResult: (t, e, s, c = {}, _ = {}) => {
            ...
            return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
              ...
              d ? m.tempC(c.rad_result.t_out, 0, !0) : ""
            }</td>\n  </tr>\n  ${l(
              "▪ Gravedad específica",
              a(e.debug_data.spGrav, 2),
              d ? a(c.debug_data.spGrav, 2) : "",
              d
            )}\n  <tr>\n    <td class="tg-simple">▪ Calor absorbido total, ${m.heat_flow(
              0,
              0,
              0,
              !0
              ...
              `▪ Calor Absorbido, ${m.heat_flow(0, 0, 0, !0)}`
      ...
      911: (t, e, s) => {
        const {
          ...
          h = (t, e, s) => {
            ...
            const n = d.filter((t) => t.Formula in a),
              r = [];
            let l = 0;
            for (const t in a)
              (r[l] = (s) =>
              ...
              : ((s.m_flue_ratio = (T * R.flue_MW) / g(N)),
                ...
                (s.adFlame = a(
                  ((t, e, s, a) => {
                    ...
                    let m = 0;
                    for (const e in t)
                      (_[m] = t[e] * C(r.filter((t) => t.Formula == e)[0])(s)),
                        m++;
                    return (t) =>
                      ((t) =>
                        e.O2 * l(t) +
        ...
        t.exports = {
          convSection: (t, e) => {
            ...
            const X = (t, e) => 1 / (1 / (z(t, e) + q()) + b),
              ...
              Z = A + T / 2,
              tt = (X(c(s, l), j(c(i, o), j(c(i, o)))) / (6 * Y * T)) ** 0.5,
            ...
            const ot = (t) => n(t, o, s, l),
              ...
              dt = (t, e) => d * f(t, e) * (t - e),
              mt = (t, e, s) => _t(c(s, e), c(t), j(c(t), j(c(t)))) * x * ot(t),
              ft = (t, e = 0.7 * s) => s - J(t) / (d * f(c(s, e))),
              pt = () => (100 * (mt(u, s, l) - J(u))) / J(u);
            for (l = ft(i), u = i; l - u < 0; ) (u *= 1.002), (l = ft(u));
            let ht, gt;
            ...
            return (
              ...
              (t.tg_conv = l),
              {
                ...
                t_fin_max:
                  o +
                  (mt(i, s, l) / (x / (t.N_conv / t.Tpr_sh_cnv))) *
                    (v / k) *
                    (O +
                      1 / K(c(i), j(c(i), j(c(i)))) +
                ...
                Uo: _t(c(s, l), c(i), j(c(i))),
                R_int: it(c(i), j(c(i))),
                R_tube: ut(j(c(i))),
                R_ext: ct(c(s, l), j(c(i))),
                TUBING: {
                  Material: t.Material,
                  Nt: S,
                  N: y,
        ...
        t.exports = {
          radSection: (t, e) => {
            ...
            const f = t.t_air,
              ...
              U = t.GCV,
              K = t.m_fluid,
              J = (e = _) => t.m_air_ratio * e,
              j = (e = _) => t.m_flue_ratio * e,
              q = t.Cp_fuel($(p, h)),
              z = t.Cp_air($(f, h)),
          ...
          shieldSection: (t, e) => {
            ...
            return (
              ...
              (t.tg_sh = o),
              {
                ...
                ho: W(o),
                hc: Q(_(s, o)),
                Uo: J(o, s, _(u), L(_(u), L(_(u)))),
                R_int: V(_(u), L(_(u), L(_(u)))),
                R_tube: U(L(_(u), L(_(u)))),
                R_ext: K(o, s),
                TUBING: {
                  Material: t.Material,
                  Nt: t.Tpr_sh_cnv,
