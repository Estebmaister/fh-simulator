(() => {
      ...
      t.exports = {
        compactResult : (t, e, s, n) => {
          ...
          localStorage.setItem(`${s.title}`,
              ...
              s.title === l
                  ? (m = s, d = u, p = JSON.parse(localStorage.getItem(o)),
                     i(p, o) && (p = !1), f = p ? p.opt : {},
                     _ = p ? p.result : {})
                  : (f = s, _ = u, p = JSON.parse(localStorage.getItem(l)),
                     i(p, l) && (p = !1),
    ...
    566 : (t, e, s) => {
      ...
      t.exports = {
        graphicData : (t, e, s) => {
          ...
          _ || (_ = {}),
              _[`${window.location.search}`] = i, _.time = {date : Date.now()},
              localStorage.setItem(u, JSON.stringify(_)), console.log(i),
              r(i, s), l && l.remove()
        }
      }
    },
        ...
        stringShldResult : (t, e, s) => {
          ...
          return l = "es" == t ? "Resultados sección de escudo:"
                 ...
                 l += `\n\n  t_in:     ${r.tempC(e.t_in)}\n  t_out:    ${
                     ...
                     a(Math.log(e.DeltaA / e.DeltaB), 1, !0)}\n\n  Q_flue:   ${
                     r.heat_flow(
          ...
          return l = "es" == t
                         ...
                         : `\nInput Data\n  (Default values will be taken in case\n    of no entries)\n\n  Unit System:           ${
                               ...
                               a(e.flows.AC,
                                 3)}\n    A/F mass (wet basis):    ${
                               a(e.flows.AC_mass,
                                 3)}\n    A/F molar stoichiometric (dry basis): ${
                               a(e.flows.AC_theor_dryAir,
                                 3)}\n    A/F mass stoichiometric (dry basis):  ${
                               a(e.flows.AC_mass_theor_moistAir,
        ...
        stringCompactResult : (t, e, s, c = {}, d = {}) => {
          ...
          return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
              ...
              m.tempC(e.rad_result.t_out, 0,
                      !0)}</td>\n    <td class="tg-simple">${
              _ ? m.tempC(c.rad_result.t_out, 0, !0) : ""}</td>\n  </tr>\n  ${
              ...
              _ ? m.tempC(d.tAir, 0, !0) : ""}</td>\n  </tr>\n  ${
              r("Humedad relativa, %", e.debug_data, _ ? c.debug_data : {},
                "humidity_%", _, 1, 0)}\n  ${
              r("Pérdidas por radiación al ambiente, %", s, d, "hLoss", _, 100,
                1)}\n  \n  ${i("Características del Combustible")}\n  ${
              f = "Composición (100%)",
      `<tr><td colspan="3"><b>${f}</b></td></tr>`}\n  ${
              r("Metano (CH4)", e.fuel, c.fuel, "CH4", _, 100)}\n  ${
              r("Etano (C2H6)", e.fuel, c.fuel, "C2H6", _, 100)}\n  ${
              r("Propano (C3H8)", e.fuel, c.fuel, "C3H8", _, 100)}\n  ${
              r("n-Butano (C4H10)", e.fuel, c.fuel, "C4H10", _, 100)}\n  ${
              r("i-Butano (C4H10)", e.fuel, c.fuel, "iC4H10", _, 100)}\n  ${
              r("Etileno (C2H4)", e.fuel, c.fuel, "C2H4", _, 100)}\n  ${
              r("Propileno (C3H6)", e.fuel, c.fuel, "C3H6", _, 100)}\n  ${
              r("Monóxido de Carbono (CO)", e.fuel, c.fuel, "CO", _, 100)}\n  ${
              r("Hidrógeno (H2)", e.fuel, c.fuel, "H2", _, 100)}\n  ${
              r("Nitrógeno (N2)", e.fuel, c.fuel, "N2", _, 100)}\n  ${
              r("Dióxido de Carbono (CO2)", e.fuel, c.fuel, "CO2", _,
                100)}\n  ${
              ...
              a(e.flows["H2O_%"], 2)}</td>\n    <td class="tg-simple">${
              _ ? a(c.flows["H2O_%"], 2) : ""}</td>\n  </tr>\n  ${o}\n  ${
              l("▪ Emisiones de CO2, toneladas/año",
                a(e.rad_result.co2_emiss, 0),
                _ ? a(c.rad_result.co2_emiss, 0) : "", _)}\n  ${o}\n\n  ${
              u(`▪ Pérdidas de calor, ${
                  m.heat_flow(
                      0, 0, 0,
              ...
              a(100 * e.conv_result.Q_stack / e.rad_result.Q_in,
                2)})</td>\n    <td class="tg-simple">${
              _ ? m.heat_flow(c.conv_result.Q_stack, 3, !0) +
                      ` - (${
              ...
              a(100 * e.rad_result.Q_losses / e.rad_result.Q_in,
                2)})</td>\n    <td class="tg-simple">${
              _ ? m.heat_flow(c.rad_result.Q_losses, 3, !0) +
                      ` - (${
    ...
    911 : (t, e, s) => {
     ...
     h =
          (t, e, s) => {
            ...
            const n = _.filter((t => t.Formula in a)), r = [];
            let l = 0;
            for (const t in a)
     ...
     $ =
          (t, e) => {
            ...
            return s <= 0 && (a = .855 * a - 4.86 + 244e-6 * a ** 2),
                   a * e * .01
          },
     C = (t, e) =>
          "-" === t.Cp0
          ...
          : void 0 === e ? e => t.h0 + (e - n.tempAmbRef) *
                         ...
                         : t.h0 + (e - n.tempAmbRef) *
                                      p(t, !0, !0)((n.tempAmbRef + e) / 2),
     b = (t, e, s, a = !1) => {
       const r = C(_[6]), l = C(_[34]), o = C(_[2]);
       let i = C(_[31]);
      ...
      t.exports = {
        combSection : (t, e, s, p) => {
          ...
          const y = {O2 : 0, N2 : 0, H2O : 0, CO2 : 0, SO2 : 0}, F = {...m};
          ((t, e, s) => {
            for (const a of t)
              for (const t in e)
                if ("N2" != t)
          ...
          if (y.O2 <= 0 || y.N2 < 0)
            r.error(
                `airExcess set to 0, O2 in fuel >= O2 needed. Products: {O2:${
                    y.O2}, N2:${y.N2}}`),
                A = 0, S = 0, y.N2 = N.N2, y.O2 = -y.O2;
          else {
            const t = $(s.t_air, s.humidity), e = s.p_atm - t;
            F.N2 = .7905 * e / s.p_atm, F.O2 = .2095 * e / s.p_atm,
            F.H2O = t / s.p_atm, v.dryAirPressure = b.pressure(e),
            v.waterPressure = b.pressure(t),
            v["H2OPressure_%"] = l(100 * F.H2O),
            v["N2Pressure_%"] = l(100 * F.N2),
            v["O2Pressure_%"] = l(100 * F.O2), y.O2 = A - y.O2,
            y.N2 += y.O2 * (F.N2 / F.O2), y.H2O += y.N2 * (t / (F.N2 * s.p_atm))
          }
          let T = 0, M = 0;
          for (const t in y)
            T += y[t], "H2O" !== t && (M += y[t]);
          ...
          return p ? {flows : R, products : y, debug_data : v}
                   : (s.m_flue_ratio = T * R.flue_MW / g(N),
                      ...
                      s.Pco2 = y.CO2 / T, s.Ph2o = y.H2O / T, s.Cp_air = h(F),
                      ...
                      r.info(`Adiabatic flame temp: [${l(s.adFlame)} K] ${
                          b.tempC(s.adFlame)}`),
                      R.adFlame = s.adFlame, o(y), "" == v.err && delete v.err,
      ...
      t.exports = {
        convSection : (t, e) => {
          ...
          const c = (t, e = o) => .5 * (t + e), d = t.m_fluid, _ = t.m_flue,
                ...
                y = t.N_conv, F = t.Tpr_sh_cnv, S = t.Nf, A = t.Lf, T = t.Tf,
          ...
          const X = (t, e) => 1 / (1 / (z(t, e) + q()) + b), Y = A + T / 2,
                Z = (X(c(s, l), j(c(i, o), j(c(i, o)))) / (600 * T)) ** .5,
                tt = Math.tanh(Z * Y) / (Z * Y), et = tt * (.7 + .3 * tt),
                st = v + 2 * A,
                at = et * (.45 * Math.log(st / v) * (et - 1) + 1),
                  ...
                  const n = e.Lf, r = 1 / e.Nf - e.Tf,
                        ...
                        _ = (t, e) =>
                            t + (e - t) / ((Math.exp(1.4142 * s * a) +
                                            Math.exp(-1.4142 * s * a)) /
                                           2);
                  return e.Ts = _, (e, s) => (e => .25 * t(e) ** -.35)(e) * l *
                                             c * d ** .5 * (e / _(e, s)) ** .25
                })(U, t, Z, Y)(e, s);
          ...
          const lt = t => n(t, o, s, l),
                ...
                dt = (t, e) => _ * f(t, e) * (t - e),
                _t = (t, e, s) =>
                    ct(c(s, e), c(t), j(c(t), j(c(t)))) * x * lt(t),
                mt = (t, e = .7 * s) => s - J(t) / (_ * f(c(s, e))),
                ft = () => 100 * (_t(u, s, l) - J(u)) / J(u);
          for (l = mt(i), u = i; l - u < 0;)
            u *= 1.002, l = mt(u);
          let pt, ht;
          for (let t = 0; t < 100 && !(Math.abs(ft()) < .001); t++)
            l - u < 0 || ft() <= 0
                ? (pt = u, pt &&ht ? u = (pt + ht) / 2 : u *= 1.001)
                : (ht = u, pt &&ht ? u = (pt + ht) / 2 : u *= .999),
                l = mt(u);
          return i = u,
                 e ||
                     a.default(
            ...
            t_fin: t.Ts(c(i), j(c(i), j(c(i)))),
                t_fin_max: o +
                    _t(i, s, l) / (x / (t.N_conv / t.Tpr_sh_cnv)) * (v / k) *
                ...
                rfi: O, rfo: b, LMTD: lt(i), DeltaA: s - o, DeltaB: l - i,
                Q_flue: dt(s, l), Q_fluid: J(i), Q_conv: _t(i, s, l),
                ...
                Uo: ct(c(s, l), c(i), j(c(i))), R_int: ot(c(i), j(c(i))),
                R_tube: it(j(c(i))), R_ext: ut(c(s, l), j(c(i))), TUBING: {
                  Material: t.Material,
                  Nt: F,
                  N: y,
                  Sch: t.Sch_sh_cnv,
      ...
      t.exports = {
        radSection : (t, e) => {
          ...
          const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                ...
                K = t.m_fluid, J = (e = d) => t.m_air_ratio * e,
                ...
                dt = (t, e) => j(e) * Y(t, h) * (t - h), _t = t => ut(t) * L,
                mt = (t, e) => S * R * (t - e),
                ...
                $t = (t, e) => K * X(e, t) * (t - e);
          if (0 !== c) {
            _ = $t(c, g), m = _ * W, u = g + _ * (1 - W) / (K * X(g, c));
            ...
            e || n.debug(`"mass_fuel_seed", "value": "${o}"`),
                ...
                o && (d = o), m = ht(s, lt($(c), lt($(c))))
          } else {
            _ = ut(d) * G, m = _ * W, u = g + _ * (1 - W) / (K * X(g));
            let r = g + _ / (K * X(u));
            const l = a((t => ct(d) - gt(t, d, lt($(r), lt($(r))))), 1e3,
          ...
          e || n.default(`RADI, T_in_calc: ${t.units.tempC(u)}, M_fuel: ${
              ...
              t.m_flue = j(d), t.m_air = J(d), t.t_w_rad = lt($(c), lt($(c))),
      ...
      t.exports = {
        shieldSection : (t, e) => {
          ...
          const d = (t, e = i) => .5 * (t + e), _ = t.m_fluid, m = t.m_flue,
                ...
                y = t.Do_shld - 2 * t.Sch_sh_cnv, F = t.Pitch_sh_cnv,
                S = v * Math.PI * N * k, A = Math.PI * y ** 2 / 2,
                T = v / 2 * (F - N) * k, M = 3.6,
                R = t => C(t) * M * f(t) / h(t),
                H = t => b(t) * M * p(t) / $(t), I = _ / M / A,
          ...
          return e || n.default(`SHLD, cycles: ${et}, T_in_calc: ${
            ...
            m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: u,
                t_out: i, Tb: d(u), Tw: L(d(u), L(d(u))), tg_out: o, tg_in: s,
                Tb_g: d(s, o), LMTD: r(u, i, s, o), DeltaA: s - i,
                DeltaB: o - u, rfi: w, rfo: O, Q_flue: Y(s, o), Q_fluid: X(u),
                Q_R: z(u, s, o, d(u), L(d(u))), Q_rad: j,
                Q_conv: q(u, s, o, d(u), L(d(u))), Cp_fluid: f(u, i),
                Cp_flue: p(s, o), miu_fluid: C(L(d(u))), miu_flue: b(o),
                duty: G(u), "%": G(u) / t.duty, duty_flux: G(u) / S,
                kw_fluid: h(d(u)), kw_tube: g(L(d(u))), kw_flue: $(d(s, o)),
                Prandtl: l(R(d(i))), Reynolds: l(x(d(i))),
                PrandtlFlue: l(H(d(i))), ReynoldsFlue: l(P(d(i))), At: S, Ai: A,
                An: T, Gn: D, hi: B(d(u)), hi_tw: B(d(u), L(d(u))), hr: E(s),
                ho: W(o), hc: Q(d(s, o)), Uo: J(o, s, d(u), L(d(u), L(d(u)))),
                R_int: V(d(u), L(d(u), L(d(u)))), R_tube: U(L(d(u), L(d(u)))),
                R_ext: K(o, s), TUBING: {
                  Material: t.Material,
                  Nt: t.Tpr_sh_cnv,
                  N: v,
    ...
    170 : t => {
      ...
      const
          ...
          _ = ({k0 : t, k1 : e, k2 : a, Substance : n}) =>
              0 == t || "-" == t
                  ? (s.debug(
                         `"Thermal Cond func called for '${n}' without coffs"`),
                     () => 0)
                  : s => 3.6 * (t + e * s + a * s ** 2),
          ...
          p = {
            ...
            fouling_factor : (t, e, s, a) => f(
                a, s, e, "h-ft²-°F/Btu", i.m2toft2(t) * i.KtoR() / i.kJtoBTU()),
            "energy/mass" : (t, e, s, a) =>
            ...
            convect : (t, e, s, a) => f(a, s, e, "BTU/h-ft²-°F",
          ...
          h = {
            ...
            barrel_flow : (t, e, s, a, n = .84) => p.barrel_flow(t, e, s, a, n),
  ...
  (() => {
   ...
   d = s(684), {radSection : _} = s(623), {convSection : m} = s(399),
   ...
   {browserProcess : h} = s(620), g = (t, e) => {
     const s = (t => {
       const e = r.BPDtolb_h(r.lbtokg(t.mFluid), t.spGrav), s = t.tIn,
             a = t.tOut, n = t.miuFluidIn, i = t.miuFluidOut, d = t.cpFluidIn,
             _ = t.cpFluidOut, m = r.kwENtokwSI(t.kwFluidIn),
     ...
     return s.runDistCycle && $(s),
            a.rad_result = _(s), a.shld_result = f(s), a.conv_result = m(s),
    ...
    let b = {...e};
    "undefined" != typeof window ? h(b, d, n, g)
