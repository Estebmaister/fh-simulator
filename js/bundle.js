        ...
        597 : (t, e, s) => {
          ...
          r(t, e, s, a,
            ...
            const w = `${b}`, v = d3.extent(o, h),
                  ...
                  M = A.append("g").call(S).attr("transform",
                                                 `translate(0,${u})`);
          ...
          t.exports = {
            draw : function(t = [], e = {}) {
              ...
              r(e, "m_fuel", 0, 0 * s, u),
                  r(e, "cnv_tg_out", 1 == n ? 0 : a / 2, 1 == n ? .5 * s : 0,
                    u),
                  r(e, "rad_dist", 0, 1 == n ? 1 * s : s / 2, u),
                  r(e, "cnv_dist", 1 == n ? 0 : a / 2, 1 == n ? 1.5 * s : s / 2,
                    u),
          ...
          t.exports = {
            combSection : (t, e, s, p) => {
              ...
              return p || (s.m_flue_ratio = M * I.flue_MW / g(N),
                           ...
                           I.NCV_val = s.NCV, I.GCV_val = s.GCV,
                           s.adFlame = a(
                               ((t, e, s, a) => {
                                 void 0 === s && (s = n.tAmb),
                                     void 0 === a && (a = 0);
              ...
              {
                flows: I, products: y, debug_data: v
              }
            }
          }
        },
            ...
            convSection : (t, e) => {
              ...
              const c = (t, e = o) => .5 * (t + e), d = t.m_fluid, _ = t.m_flue,
                    ...
                    j = (t = c(o, i), e = t, s = i) =>
                        ...
                        t,
                    q = (t, e) => 2.2 * 2.7431452152 * B ** .5 * (I / R) ** .75;
              ...
              return i = u,
                ...
                t_fin: t.Ts(c(i), j(c(i), j(c(i)))),
                    ...
                    Ai: D, An: T, Ao: R, Apo: I, Afo: H, Ef: nt, Gn: V / E,
          ...
          t.exports = {
            radSection : (t, e) => {
              ...
              const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                    ...
                    I = b * Math.PI * k * w, R = b * y * w, H = O / 2 * S * v,
                    x = (t => {
                      const e =
          ...
          t.exports = {
            shieldSection : (t, e) => {
              ...
              const d = (t, e = i) => .5 * (t + e), _ = t.m_fluid, m = t.m_flue,
                    ...
                    M = v / 2 * (S - N) * k, T = 3.6,
                    I = t => C(t) * T * f(t) / h(t),
                    R = t => b(t) * T * p(t) / $(t), H = _ / T / A,
                    x = t => H * y / C(t), D = m / T / M, P = t => D * N / b(t),
                    B = (t, e = t) => h(t) / y * .023 * x(t) ** .8 * I(t) **
                                      (1 / 3) * (C(t) / C(e)) ** .14,
                    E = t => .092 * t - 34,
                    Q = t => $(t) / N * .33 * R(t) ** (1 / 3) * P(t) ** .6,
              ...
              return e || n.default(`SHLD, cycles: ${et}, T_in_calc: ${
                ...
                m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: u,
                    ...
                    Prandtl: r(I(d(i))), Reynolds: r(x(d(i))),
                    PrandtlFlue: r(R(d(i))), ReynoldsFlue: r(P(d(i))), At: F,
