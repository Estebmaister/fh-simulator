(() => {
  var t = {
          ...
          compactResult: (t, e, s, n) => {
            ...
            localStorage.setItem(
              ...
              s.title === r
                ? ((_ = s),
                  (c = i),
                  (f = JSON.parse(localStorage.getItem(l))),
                  o(f, l) && (f = {}),
                  (m = f ? f.opt : {}),
                  (d = f ? f.result : {}))
                : ((m = s),
        ...
        function r(
          ...
          const w = `${b}`,
            ...
            y = d3
              ...
              .nice(),
            N = d3.axisBottom(k).tickSize(-u).tickPadding(15),
            S = d3.axisLeft(y).ticks(8).tickSize(-c).tickPadding(10),
            F = l
              .append("g")
              .attr(
                "transform",
            ...
            A = F.append("g").call(N).attr("transform", `translate(0,${u})`);
      ...
      144: (t, e, s) => {
        ...
        t.exports = {
              ...
              (l =
                "es" == t
                  ...
                  : `\nInput Data\n  (Default values will be taken in case\n    of no entries)\n\n  Unit System:           ${
                      ...
                      e.rad_result.eff_thermal_val,
                      2
                    )}%\n  Heater Thermal Efficiency (GCV): ${a(
                      e.rad_result.eff_gcv_val,
                      2
                    )}%\n\n  CO2 Emissions: ${a(
                      ((44.01 * e.products.CO2) / e.flows.fuel_MW) *
                      ...
                      e.flows.O2_mol_req_theor,
                      3
                    )}\n\n  A/F Ratios\n  A/C molar (wet basis):   ${a(
                      e.flows.AC,
                      3
                    )}\n  A/C mass (wet basis):    ${a(
                      e.flows.AC_mass,
                      3
                    )}\n  A/C molar stoichiometric (dry basis): ${a(
                      e.flows.AC_theor_dryAir,
                      3
                    )}\n  A/C mass stoichiometric (dry basis):  ${a(
                      e.flows.AC_mass_theor_moistAir,
                      3
          ...
          stringCompactResult: (t, e, s, r = {}, l = {}) => {
            const o = null != l.title,
              i = n(t);
            return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
              e.debug_data.unitSystem
            }) <b>Caso</b></th>\n    <th>${s.title.toUpperCase()}</th>\n    <th>${
              o ? "MODIFICADO" : ""
            }</th>\n  </tr>\n</thead>\n<tbody>\n  <tr>\n    <td class="tg-mqa1" colspan="3">Condiciones de Proceso</td>\n  </tr>\n  <tr>\n    <td class="tg-simple" colspan="3">Residuo atmosférico</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Flujo volumétrico, ${i.barrel_flowC(
              0,
              0,
              0,
              !0
            )}</td>\n    <td class="tg-simple">${i.barrel_flowC(
              s.mFluid,
              0,
              !0
            )}</td>\n    <td class="tg-simple">${
              o ? i.barrel_flowC(l.mFluid, 0, !0) : ""
              ...
              o ? i.tempC(r.conv_result.t_in_given, 0, !0) : ""
              ...
              o ? i.tempC(r.rad_result.t_out, 0, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Gravedad específica</td>\n    <td class="tg-simple">${
              e.debug_data.spGrav
            }</td>\n    <td class="tg-simple">${
              o ? r.debug_data.spGrav : ""
              ...
              o ? i.heat_flow(r.rad_result.duty_total, 3, !0) : ""
              ...
              o ? i.fouling_factor(r.rad_result.rfi, 3, !0) : ""
              ...
              o ? i.fouling_factor(r.conv_result.rfi, 3, !0) : ""
              ...
              o ? i.fouling_factor(r.conv_result.rfo, 3, !0) : ""
              ...
              o ? i.tempC(l.tAir, 0, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">Humedad relativa, %</td>\n    <td class="tg-simple">${a(
              e.debug_data["humidity_%"],
              0
            )}</td>\n    <td class="tg-simple">${
              o ? a(r.debug_data["humidity_%"], 0) : ""
              ...
              o ? i["mass/mol"](r.flows.fuel_MW, 3, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">Calor específico Cp(T comb), ${i.cp(
              0,
              0,
              0,
              !0
              ...
              o ? i.cp(r.flows.Cp_fuel_val, 3, !0) : ""
              ...
              o ? i["energy/mass"](r.flows.NCV_val, 0, !0) : ""
              ...
              o ? i["energy/mass"](r.flows.GCV_val, 0, !0) : ""
              ...
              o ? i.mass_flow(r.rad_result.m_fluid, 1, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">· Combustible</td>\n    <td class="tg-simple">${i.mass_flow(
              e.rad_result.m_fuel,
              2,
              !0
            )}</td>\n    <td class="tg-simple">${
              o ? i.mass_flow(r.rad_result.m_fuel, 2, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">· Aire</td>\n    <td class="tg-simple">${i.mass_flow(
              e.rad_result.m_air,
              2,
              !0
            )}</td>\n    <td class="tg-simple">${
              o ? i.mass_flow(r.rad_result.m_air, 2, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">· Gases de combustión</td>\n    <td class="tg-simple">${i.mass_flow(
              e.rad_result.m_flue,
              2,
              !0
            )}</td>\n    <td class="tg-simple">${
              o ? i.mass_flow(r.rad_result.m_flue, 2, !0) : ""
              ...
              o ? i.moist(r.flows.moisture_val, 3, !0) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ (A/C) Masa BH</td>\n    <td class="tg-simple">${a(
              e.flows.AC_mass,
              3
            )}</td>\n    <td class="tg-simple">${
              o ? a(r.flows.AC_mass, 3) : ""
              ...
              o ? i.heat_flow(r.rad_result.Q_rls, 3, !0) : ""
              ...
              o ? i.heat_flow(r.rad_result.Q_in, 3, !0) : ""
              ...
              o
                ? i.heat_flow(r.rad_result.duty, 3, !0) +
                  ` - (${a(100 * r.rad_result["%"], 2)})`
                : ""
              ...
              o
                ? i.heat_flow(r.shld_result.duty, 3, !0) +
                  ` - (${a(100 * r.shld_result["%"], 2)})`
                : ""
              ...
              o
                ? i.heat_flow(r.conv_result.duty, 3, !0) +
                  ` - (${a(100 * r.conv_result["%"], 2)})`
                : ""
              ...
              o
                ? a(
                    ((44.01 * r.products.CO2) / r.flows.fuel_MW) *
                      r.rad_result.m_fuel *
                      8.76,
                    0
                  )
              ...
              o
                ? i.heat_flow(r.conv_result.Q_stack, 3, !0) +
                  ` - (${a(
                    (100 * r.conv_result.Q_stack) / r.rad_result.Q_in,
                    2
                  )})`
                : ""
              ...
              o
                ? i.heat_flow(r.rad_result.Q_losses, 3, !0) +
                  ` - (${a(
                    (100 * r.rad_result.Q_losses) / r.rad_result.Q_in,
                    2
                  )})`
                : ""
              ...
              o ? a(r.rad_result.eff_thermal_val, 2) : ""
            }</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Eficiencia Térmica @ GHV, %</td>\n    <td class="tg-simple">${a(
              e.rad_result.eff_gcv_val,
              2
            )}</td>\n    <td class="tg-simple">${
              o ? a(r.rad_result.eff_gcv_val, 2) : ""
            }</td>\n  </tr>\n</tbody>\n</table>`;
          },
        };
      },
      911: (t, e, s) => {
        ...
        t.exports = {
          combSection: (t, e, s, p) => {
            ...
            const N = { O2: 0, N2: 0, H2O: 0, CO2: 0, SO2: 0 },
              S = { ...m };
            ((t, e, s) => {
              for (const a of t)
                for (const t in e)
            ...
            if (N.O2 <= 0 || N.N2 < 0)
              r.error(
                `airExcess set to 0, O2 in fuel >= O2 needed. Products: {O2:${N.O2}, N2:${N.N2}}`
              ),
                (A = 0),
                (F = 0),
                (N.N2 = y.N2),
              ...
              (S.N2 = (0.7905 * e) / s.p_atm),
                ...
                (v["O2Pressure_%"] = l(100 * S.O2)),
                (N.O2 = A - N.O2),
                (N.N2 += N.O2 * (S.N2 / S.O2)),
                (N.H2O += N.N2 * (t / (S.N2 * s.p_atm)));
            }
            let T = 0,
              M = 0;
            for (const t in N) (T += N[t]), "H2O" !== t && (M += N[t]);
            const R = {
              total_flow: T,
              dry_total_flow: M,
              "N2_%": (100 * N.N2) / T,
              ...
              AC_mass: ((A / S.O2) * g(S)) / g(y),
              AC_mass_theor_moistAir: ((F / S.O2) * g(S)) / g(y),
              fuel_MW: g(y),
              Cp_fuel: h(y),
              flue_MW: g(N, p),
              Cp_flue: h(N, !1, p),
            ...
            return (
              p ||
                ((s.m_flue_ratio = (T * R.flue_MW) / g(y)),
                (s.m_air_ratio = ((A / S.O2) * g(S)) / g(y)),
                (s.Pco2 = N.CO2 / T),
                (s.Ph2o = N.H2O / T),
                (s.Cp_air = h(S)),
                (s.Cp_fuel = h(y)),
                ...
                (s.NCV = -O(y, N, k, s.t_amb) / g(y)),
                (s.GCV = -O(y, N, k, s.t_amb, !0) / g(y)),
          ...
          convSection: (t, e) => {
            ...
            const c = (t, e = o) => 0.5 * (t + e),
              ...
              j = (t = c(o, i), e = t, s = i) =>
                ...
                t,
              q = (t, e) => 2.2 * 2.7431452152 * B ** 0.5 * (R / I) ** 0.75;
            let z = (t, e) => (g(t) / v) * 0.33 * W(t) ** (1 / 3) * U(t) ** 0.6;
            const X = (t, e) => 1 / (1 / (z(t, e) + q()) + b),
              Y = 1.36 * h(j(c(i, o), j(c(i, o)))),
              Z = A + T / 2,
              tt = (X(c(s, a), j(c(i, o), j(c(i, o)))) / (6 * Y * T)) ** 0.5,
              et = Math.tanh(tt * Z) / (tt * Z),
              st = et * (0.7 + 0.3 * et),
              at = v + 2 * A,
              nt = st * (0.45 * Math.log(at / v) * (st - 1) + 1),
              rt = (t, e) => (X(t, e) * (nt * H + R)) / I,
              lt = (e, s) =>
                ((t, e, s, a) => {
                  const n = e.Lf,
                    r = 1 / e.Nf - e.Tf,
            ...
            z = (t, e) => lt(t, e) * V * f(t) * W(t) ** -0.67;
            const ot = (t) => r(t, o, s, a),
              ...
              _t = (t, e) => _ * f(t, e) * (t - e),
              mt = (t, e, s) => dt(c(s, e), c(t), j(c(t), j(c(t)))) * x * ot(t),
              ft = (t, e = 0.7 * s) => s - J(t) / (_ * f(c(s, e))),
              pt = () => (100 * (mt(u, s, a) - J(u))) / J(u);
            for (a = ft(i), u = i; a - u < 0; ) (u *= 1.002), (a = ft(u));
            let ht, gt;
            ...
            return (
              ...
              (t.tg_conv = a),
              {
                ...
                he: rt(c(s, a), j(c(i), j(c(i)))),
                j: lt(c(s, a), j(c(i), j(c(i)))),
                gr: (c(s, a), j(c(i), j(c(i))), 2.7431452152),
                Uo: dt(c(s, a), c(i), j(c(i))),
                R_int: it(c(i), j(c(i))),
                R_tube: ut(j(c(i))),
                R_ext: ct(c(s, a), j(c(i))),
                TUBING: {
                  Material: t.Material,
                  Nt: S,
                  N,
          ...
          radSection: (t, e) => {
            ...
            const f = t.t_air,
              ...
              lt = (t, e = t, s = m) =>
                (s / R) *
                  (k / y) *
                  (C + 1 / rt(t, e) + (y * Math.log(k / y)) / (2 * tt(e))) +
                t,
              ot = (t) => J(t) * z * (f - h),
              it = (t) => t * q * (p - h),
              ut = (t) => t * V,
          ...
          shieldSection: (t, e) => {
            ...
            const d = (t, e = i) => 0.5 * (t + e),
              ...
              B = (t, e = t) =>
                ...
                (C(t) / C(e)) ** 0.14,
              E = (t) => 0.092 * t - 34,
              Q = (t) => ($(t) / y) * 0.33 * I(t) ** (1 / 3) * P(t) ** 0.6,
              W = (t, e = s) => 1 / (1 / (Q(d(t, e)) + E(d(t, e))) + O),
              G = (t) => _ * f(t) * (i - t),
              L = (t, e = t, s = u) =>
                (G(s) / F) *
                  (y / N) *
                  (w + 1 / B(t, e) + (N * Math.log(y / N)) / (2 * g(e))) +
                t,
              V = (t, e) => y / (N * B(t, e)) + (y / N) * w,
              U = (t) => (y * Math.log(y / N)) / (2 * g(t)),
              K = (t, e = s) => 1 / W(t, e),
              J = (t, e, s, a) =>
  ...
  (() => {
    const {
      ...
      h = (t, e) => {
        const s = ((t) => {
          const e = n.BPDtolb_h(n.lbtokg(t.mFluid), t.spGrav),
            s = t.tIn,
            a = t.tOut,
            o = t.miuFluidIn,
            c = t.miuFluidOut,
          ...
          return {
            ...
            max_duty: n.BTUtokJ(71527.6),
            miu_fluid: i({ t1: s, v1: o, t2: a, v2: c }),
            Cp_fluid: l({ x1: s, y1: d, x2: a, y2: _ }),
            kw_fluid: l({ x1: s, y1: m, x2: a, y2: f }),
            Material: "A-312 TP321",
            h_conv: n.hcENtohcSI(1.5),
            kw_tube: u,
            Pass_number: 2,
            Pitch_rad: n.intom(16),
            N_rad: 42,
            L_rad: n.fttom(62.094),
            Do_rad: n.intom(8.625),
            Sch_rad: n.intom(0.322),
            Burner_number: 13,
            Do_Burner: 2.24,
            Width_rad: 17.5,
            Length_rad: 64.55,
            ...
            N_shld: 16,
            L_shld: n.fttom(60),
            Do_shld: n.intom(6.625),
            Pitch_sh_cnv: n.intom(12),
            Sch_sh_cnv: n.intom(0.28),
            Tpr_sh_cnv: 8,
            N_conv: 40,
            L_conv: n.fttom(60),
            Do_conv: n.intom(6.625),
            Nf: n.mtoft(60),
            Tf: n.fttom(0.005),
            Lf: n.fttom(0.08),
            FinType: "Solid",
      ...
      g = (s) => {
        ...
        l > 0.1 && l < 1
          ...
          e.info(`duty_rad_dist: ${t(100 * l, 2)}, ext_cycle_reps: ${a}`);
      },
      $ = (s, a) => {
        let n = 0;
        const r = { ...s.NROptions };
        ...
        l && (s.airExcess = l),
          e.info(`'air_excess': ${t(100 * l, 2)}, 'comb_cycle_reps': ${n}`);
      };
    let C = {
      H2: 0.1142,
      N2: 0.0068,
