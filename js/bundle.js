      ...
      t = {
        ...
        851 : (t, e, s) => {
          const {stringCompactResult :
                     a} = s(144),
                     {logger : n} = s(170), r = "base", l = "modified",
                     o = (t = {}, e = "") => !(
          ...
          t.exports = {
            compactResult : (t, e, s, n) => {
              ...
              localStorage.setItem(
                  ...
                  s.title === r
                      ? (_ = s, c = i, f = JSON.parse(localStorage.getItem(l)),
                         o(f, l) && (f = {}), m = f ? f.opt : {},
                         d = f ? f.result : {})
                      : (m = s, d = i, f = JSON.parse(localStorage.getItem(r)),
                         o(f, r) && (f = {}),
            ...
            graphicData : (t, e, s) => {
              ...
              for (let a = 0; a < m; a++) {
                ...
                i[a] = {
                  ...
                  m_fuel : r.rad_result.m_fuel ? n.kgtolb(r.rad_result.m_fuel)
                                               : 0,
                  ...
                  rad_cnv_dist : 0 != r.conv_result["%"]
                                     ...
                                     : 0,
                  co2_emiss : Math.round(100 * r.products.CO2 *
                                         (44.01 / r.flows.fuel_MW) *
                                         r.rad_result.m_fuel * 8.76) /
                                  100
                }
              }
              _ || (_ = {}), _[`${window.location.search}`] = i,
                             ...
                             console.log(i), r(i, s), l && l.remove()
            }
          }
        },
        597 : (t, e, s) => {
          ...
          r(t, e, s, r,
            ...
            case "cnv_tg_out":
              b = "es" == t.lang ? "Temperatura de Chimenea"
                                 : "Stack Temperature",
              "si" == t.unitSystem.toLowerCase() ? (e += "_si", O = `${b} [C]`)
                                                 : O = `${b} [F]`;
              break;
            case "rad_tg_out":
            ...
            const w = `${b}`, v = d3.extent(o, g),
                  ...
                  A = F.append("g").call(N).attr("transform",
                                                 `translate(0,${u})`);
                    ...
                    (t, e, s, r = {}, l = {}) => {
                      ...
                      return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
                          ...
                          a(44.01 * e.products.CO2 / e.flows.fuel_MW *
                                e.rad_result.m_fuel * 8.76,
                            0)}</td>\n    <td class="tg-simple">${
                          o ? a(44.01 * r.products.CO2 / r.flows.fuel_MW *
                                    r.rad_result.m_fuel * 8.76,
                                0)
                          ...
                          a(100 * e.conv_result.Q_stack / e.rad_result.Q_in,
                            2)})</td>\n    <td class="tg-simple">${
                          o ? i.heat_flow(r.conv_result.Q_stack, 3, !0) +
                                  ` - (${
                                      a(100 * r.conv_result.Q_stack /
                                            r.rad_result.Q_in,
                                        2)})`
                          ...
                          a(100 * e.rad_result.Q_losses / e.rad_result.Q_in,
                            2)})</td>\n    <td class="tg-simple">${
                          o ? i.heat_flow(r.rad_result.Q_losses, 3, !0) +
                                  ` - (${
                                      a(100 * r.rad_result.Q_losses /
                                            r.rad_result.Q_in,
                                        2)})`
        ...
        911 : (t, e, s) => {
         ...
         b = (t, e, s, a = !1) => {
           ...
           return !0 === a && (i = C(_[32])), void 0 === s && (s = n.tAmb),
                  void 0 === e ? e => t.CO2 * r(e) + t.SO2 * l(e) +
          ...
          t.exports = {
            combSection : (t, e, s, p) => {
              ...
              let y = {...e};
              f(e, v) || (y = u(e, "combSection")), ((t, e, s = {}) => {
                const a = Math.abs(e.length - Object.keys(t).length);
                0 === a ||
                    (r.error(`[some fuels aren't in the database, #badFuels: ${
                         a}],`),
                     s.err +=
                     `[some fuels aren't in the database, #badFuels: ${a}],`)
              })(y, k, v);
              const N = {O2 : 0, N2 : 0, H2O : 0, CO2 : 0, SO2 : 0}, S = {...m};
              ((t, e, s) => {
                for (const a of t)
                  for (const t in e)
                    if ("N2" != t)
              ...
              if (N.O2 <= 0 || N.N2 < 0)
                ...
                v["O2Pressure_%"] = l(100 * S.O2), N.O2 = A - N.O2,
                N.N2 += N.O2 * (S.N2 / S.O2),
              ...
              return p || (s.m_flue_ratio = T * R.flue_MW / g(y),
                           s.m_air_ratio = A / S.O2 * g(S) / g(y),
                           s.Pco2 = N.CO2 / T, s.Ph2o = N.H2O / T,
                           s.Cp_air = h(S), s.Cp_fuel = h(y),
                           s.Cp_flue = R.Cp_flue, s.miu_flue = c(_, N),
                           s.kw_flue = d(_, N),
                           ...
                           r.info(`Adiabatic flame temp: [${l(s.adFlame)} K] ${
                               b.tempC(s.adFlame)}`),
                           o(N), "" == v.err && delete v.err),
              {
                flows: R, products: N, debug_data: v
              }
            }
          }
        },
          ...
          t.exports = {
            convSection : (t, e) => {
              ...
              const c = (t, e = o) => .5 * (t + e), d = t.m_fluid, _ = t.m_flue,
                    ...
                    k = t.Do_conv - 2 * t.Sch_sh_cnv, y = t.Pitch_sh_cnv,
                    N = t.N_conv, S = t.Tpr_sh_cnv, F = t.Nf, A = t.Lf,
                    T = t.Tf, M = S * y * w - (v + 2 * A * T * F) * w * S,
                    R = Math.PI * v * (1 - F * T),
                    I = Math.PI * v * (1 - F * T) +
                        Math.PI * F * (2 * A * (v + A) + T * (v + 2 * A)),
                    H = I - R, x = N * I * w, D = Math.PI * k ** 2 / 2,
              ...
              const X = (t, e) => 1 / (1 / (z(t, e) + q()) + b),
                    ...
                    tt = (X(c(s, a), j(c(i, o), j(c(i, o)))) / (6 * Y * T)) **
                         .5,
              ...
              return i = u,
                ...
                t_fin: t.Ts(c(i), j(c(i), j(c(i)))),
                    ...
                    Q_flue: _t(s, a), Q_fluid: J(i), Q_conv: mt(i, s, a),
                    Q_stack: _t(a, t.t_air), duty: J(i), "%": J(i) / t.duty,
                    duty_flux: J(i) / x, Cp_fluid: m(i, o), Cp_flue: f(s, a),
                    miu_fluid: $(j(c(i))), miu_flue: C(a), kw_fluid: p(c(i)),
                    kw_tube: h(j(c(i))), kw_fin: Y, kw_flue: g(c(s, a)),
                    Prandtl: l(Q(c(o))), Reynolds: l(L(c(o))),
                    PrandtlFlue: l(W(c(o))), ReynoldsFlue: l(U(c(o))), At: x,
                    Ai: D, An: M, Ao: I, Apo: R, Afo: H, Ef: nt, Gn: V / E,
          ...
          t.exports = {
            radSection : (t, e) => {
              ...
              const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                    ...
                    y = t.Do_rad - t.Sch_rad, N = t.Pitch_rad || .394,
                    S = t.Pitch_sh_cnv, F = t.h_conv || 30.66,
                    A = 2 / 3 * (t.Width_rad * t.Length_rad * t.Height_rad) **
                        (1 / 3),
                    T = (t.Ph2o + t.Pco2) * A,
                    M = 1 + N / k * .49 / 6 - .09275 * (N / k) ** 2 +
                        .065 * (N / k) ** 3 / 6 + 25e-5 * (N / k) ** 4,
                    R = b * Math.PI * k * w, I = b * N * w, H = O / 2 * S * v,
                    x = (t => {
                      const e =
                          l.m2toft2(t.Pitch_sh_cnv * t.Tpr_sh_cnv * t.L_shld),
                    ...
                    B = Math.PI * y ** 2 / 2, E = 2.04133464e-7,
                    Q = t => ((t, e, s, a, n, r) => {
                    ...
                    et = e => t.miu_fluid(e), st = K / 3.6 / B,
                    at = t => et(t) * X(t) * 3.6 / Z(t),
                    nt = t => st * y / et(t),
                    rt = (t, e = t) => Z(t) / y * .023 * nt(t) ** .8 * at(t) **
                                       (1 / 3) * (et(t) / et(e)) ** .14,
                    lt = (t, e = t, s = m) =>
                        s / R * (k / y) *
                            (C + 1 / rt(t, e) +
                             y * Math.log(k / y) / (2 * tt(e))) +
                        t,
              ...
              e || n.default(`RADI, T_in_calc: ${t.units.tempC(u)}, M_fuel: ${
                  ...
                  t.m_flue = j(d), t.m_air = J(d),
                  t.t_w_rad = lt($(c), lt($(c))), t.q_rad_sh = pt(s, t.t_w_rad);
              const Ct = {
                m_air : J(),
                m_flue : j(),
                m_fuel : d,
          ...
          t.exports = {
            shieldSection : (t, e) => {
              ...
              const d = (t, e = i) => .5 * (t + e), _ = t.m_fluid, m = t.m_flue,
                    ...
                    v = t.N_shld, k = t.L_shld, y = t.Do_shld,
                    N = t.Do_shld - 2 * t.Sch_sh_cnv, S = t.Pitch_sh_cnv,
                    F = v * Math.PI * y * k, A = Math.PI * N ** 2 / 2,
                    T = v / 2 * (S - y) * k, M = 3.6,
                    R = t => C(t) * M * f(t) / h(t),
                    I = t => b(t) * M * p(t) / $(t), H = _ / M / A,
                    x = t => H * N / C(t), D = m / M / T, P = t => D * y / b(t),
                    B = (t, e = t) => h(t) / N * .023 * x(t) ** .8 * R(t) **
                                      (1 / 3) * (C(t) / C(e)) ** .14,
                    E = t => .092 * t - 34,
                    Q = t => $(t) / y * .33 * I(t) ** (1 / 3) * P(t) ** .6,
                    W = (t, e = s) => 1 / (1 / (Q(d(t, e)) + E(d(t, e))) + O),
                    G = t => _ * f(t) * (i - t),
                    L = (t, e = t, s = u) =>
                        G(s) / F * (y / N) *
                            (w + 1 / B(t, e) +
                             N * Math.log(y / N) / (2 * g(e))) +
                        t,
                    ...
                    J = (t, e, s, a) =>
                        1 /
                        ((t, e, s, a) => K(t, e) + U(a) + V(s, a))(t, e, s, a),
                    j = t.q_rad_sh,
              ...
              return e || n.default(`SHLD, cycles: ${et}, T_in_calc: ${
                ...
                m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: u,
                    ...
                    tg_in: s, Tb_g: d(s, o), LMTD: r(u, i, s, o), DeltaA: s - i,
                    ...
                    PrandtlFlue: l(I(d(i))), ReynoldsFlue: l(P(d(i))), At: F,
                    Ai: A, An: T, Gn: D, hi: B(d(u)), hi_tw: B(d(u), L(d(u))),
                    hr: E(s), ho: W(o), hc: Q(d(s, o)),
                    Uo: J(o, s, d(u), L(d(u), L(d(u)))),
                    R_int: V(d(u), L(d(u), L(d(u)))),
                    R_tube: U(L(d(u), L(d(u)))), R_ext: K(o, s), TUBING: {
                      Material: t.Material,
                      Nt: t.Tpr_sh_cnv,
                      N: v,
                      Sch: t.Sch_sh_cnv,
          ...
          t.exports = {
            optionsModifier : (t, e, s) => {
              ...
              case "rad_dist":
                r = parseFloat(e[t]),
                r >= 40 && r <= 100 &&
                    (s.radDist = .01 * r, s.runDistCycle = !1);
                break;
              case "rfi":
        ...
        170 : t => {
          const e =
              (...t) => {
                ...
                a = 273.15, n = 101325, r = 5.6145833333, l = 62.371,
                o = 288.70556, i = {
                  RtoK : (t = 1) => t * (5 / 9),
                  KtoR : (t = 1) => 1.8 * t,
          ...
          t.exports = {
            ...
            newtonRaphson : (t, e, a, n, r, l) => {
              ...
              return s.error(`Newton-Raphson (${
                         r}): Maximum iterations reached (${b})`),
                     !1
            },
            logger : s,
            round : c,
            ...
            flueViscosity : (t, e) => {
              ...
              return t => s.CO2 * r(t) + s.SO2 * a(t) + s.H2O * n(t) +
                          s.O2 * o(t) + s.N2 * l(t)
            },
            flueThermalCond : (t, e) => {
   ...
   {browserProcess : p} = s(620), h = (t, e) => {
     ...
     const l = o((t => {
                   ...
                   const e = {rad : d(s, n), shld : m(s, n), conv : _(s, n)},
                         r = Math.abs(e.rad.Q_fluid) +
                             Math.abs(e.shld.Q_fluid) +
                             Math.abs(e.conv.Q_fluid);
                   return (s.duty - r) / r
                 }),
                 s.duty_rad_dist, r, "rad_dist_final");
     l > .1 &&l < 1
         ? s.duty_rad_dist = l
         : e.error(
