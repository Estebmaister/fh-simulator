(() => {
  var e = {
          ...
          browserProcess: (e, t, n, _) => {
            ...
            const f = ((e) => {
              ...
              for (const n of e) {
                ...
                1 == e.length
                  ? (t[e[0]] = "")
                  : (t[e[0]] = decodeURIComponent(e[1].replace(/\+/g, " ")));
              }
              return t;
            ...
            f !== {} &&
              (e = ((e, t, n, a) => {
                const s = {},
                  u = n.filter((t) => t.Formula in e);
                for (const t in e)
                  if (
                    1 === u.filter((e) => e.Formula == t).length &&
                    "" !== e[t]
                  ) {
                    const n = parseFloat(e[t]);
                    n > 0 && n <= 100
                      ? (s[t] = n / 100)
                      : r.error(`fuel fraction invalid (${n}) for ${t}`);
                  } else "" !== e[t] && void 0 !== e[t] && o(t, e, a);
              ...
              d[1].includes("_graph") || d[2].includes("_graph")
                ...
                : ((e, t, n, o) => {
                    ...
                    const a = document.getElementById("loader-wrapper");
                    a && a.remove();
                    const _ = document.getElementById("output-combustion");
                    _ && (_.textContent = i(n, e, o));
                    const c = document.getElementById("output-radiant");
                    c && (c.textContent = s(n, e.rad_result, o));
                    const d = document.getElementById("output-shield");
                    d && (d.textContent = u(n, e.shld_result, o));
                    const f = document.getElementById("output-convective");
          ...
          graphicData: (e, t, n) => {
            ...
            switch (n.graphVar) {
              case "humidity":
                ...
                break;
              case "air_excess":
                (l = "airExcess"), (n.graphRange = 0.01 * n.graphRange);
                break;
              case "o2_excess":
                (l = "o2Excess"), (n.graphRange = 0.01 * n.graphRange);
                break;
              case "m_fluid":
                (l = "mFluid"),
            ...
            const _ = n.graphPoints,
              c = n.graphRange;
            let d = n[l] - c / 2;
            d < 0 && (d = 0),
              r.info(
                `Var: ${l}, centerValue: ${n[l]}, range: ${c}, points: ${_}`
              );
            for (let o = 0; o < _; o++) {
              n[l] = d + (o * c) / _;
              const r = e(t, n);
              s[o] = {
                m_fluid: 0.001 * a.lb_htoBPD(a.kgtolb(r.rad_result.m_fluid)),
                ...
                m_fuel: r.rad_result.m_fuel ? a.kgtolb(r.rad_result.m_fuel) : 0,
                efficiency: r.rad_result.eff_total ? r.rad_result.eff_total : 0,
                rad_dist:
                  r.rad_result["%"] < 1
      ...
      911: (e, t, n) => {
        const {
          ...
          d = n(684),
          f = { O2: 0.2095, N2: 0.7905, H2O: 0 },
          m = (e, t = {}) => {
            const n = Object.values(e).reduce((e, t) => e + t),
              o = Math.abs(1 - n) <= 3e-12;
            return (
              o ||
                (t.err += `[fuel fraction not equal to 1, total: ${n}. fuels: ${Object.keys(
                  e
                )}],`),
              o
            );
          ...
          h =
            ({ c0: e, c1: t, c2: n, c3: o, MW: a, Substance: u }, l, i) =>
            (_) => (
              _ < 250 &&
                !i &&
                r.debug(
                  `"Cp0", "temp": ${s(
                    _
                  )},"Msg": "${u} bellow range for Cp0 formula"`
                ),
              _ > 1200 &&
                !i &&
                r.debug(
                  `"Cp0", "temp": ${s(
                    _
                  )},"Msg": "${u} above range for Cp0 formula"`
                ),
              "-" === e
                ? (r.debug(
                    `"Cp0", "Msg": "Wrong use, called for compound ${u}, no data found"`
                  ),
                  0)
                : l
                ? a *
          ...
          p = (e, t, n) => {
            ...
            const a = d.filter((e) => e.Formula in o),
              r = [];
            let s = 0;
            for (const e in o)
              (r[s] = (n) =>
                o[e] * h(a.filter((t) => t.Formula == e)[0], t)(n)),
                s++;
            return r.reduce(
              (e, t) => (n) => e(n) + t(n),
              (e) => 0
          ...
          $ = (e, t) => {
            const n = e - a.tempToK;
            return 610.78 * Math.exp((n / (n + 238.3)) * 17.2694) * t * 0.01;
          },
          g = (e, t) => {
            const n = $(e, t);
          ...
          C = (e, t) =>
            "-" === e.Cp0
              ? "-" === e.h0
                ? (r.warn(
                    `wrong use of deltaH func, called for compound ${e.Substance} without data`
                  ),
                  void 0 === t ? () => 0 : 0)
                : void 0 === t
                ? () => e.h0
              ...
              ? (t) =>
                  e.h0 +
                  (t - a.tempAmbRef) * h(e, !0, !0)((a.tempAmbRef + t) / 2)
              : e.h0 +
                (t - a.tempAmbRef) * h(e, !0, !0)((a.tempAmbRef + t) / 2),
          b = (e, t, n, o) => {
            const r = C(d[6]),
          ...
          combSection: (e, t, n, h) => {
            ...
            const k = l(n.unitSystem),
              w = {
                ...
                spGrav: n.sp_grav,
                cpFluidTb: k.cp(n.Cp_fluid((n.t_in_conv + n.t_out) / 2)),
                unitSystem: k.system[n.lang],
              },
              N = d.filter((e, n, o) => e.Formula in t);
            let v = { ...t };
            m(t, w) || (v = i(t, "combSection")),
              ((e, t, n = {}) => {
                const o = Math.abs(t.length - Object.keys(e).length);
                0 === o ||
                  (r.error(
                    `[some fuels aren't in the database, #badFuels: ${o}],`
                  ),
                  (n.err += `[some fuels aren't in the database, #badFuels: ${o}],`));
              })(v, N, w);
            ...
            if (y.O2 <= 0 || y.N2 < 0)
              ...
              const e = $(n.t_air, n.humidity),
                t = n.p_atm - e;
              (S.N2 = (0.7905 * t) / n.p_atm),
                (S.O2 = (0.2095 * t) / n.p_atm),
                (S.H2O = e / n.p_atm),
                (w.dryAirPressure = k.pressure(t)),
                (w.waterPressure = k.pressure(e)),
                (w["H2OPressure_%"] = s(100 * S.H2O)),
                (w["N2Pressure_%"] = s(100 * S.N2)),
                (w["O2Pressure_%"] = s(100 * S.O2)),
                (y.O2 = A - y.O2),
                (y.N2 += y.O2 * (S.N2 / S.O2)),
            ...
            let M = 0,
              T = 0;
            for (const e in y) (M += y[e]), "H2O" !== e && (T += y[e]);
            const I = {
              total_flow: M,
              dry_total_flow: T,
              "N2_%": (100 * y.N2) / M,
              ...
              h ||
                ...
                (n.NCV =
                  -((e, t, n, o) => {
                    ...
                    for (const r in e) {
                      if (r in t) continue;
                      const s = n.filter((e) => e.Formula == r)[0];
                      a += e[r] * b(s)(o);
                    }
                    return a;
                  })(v, y, N, n.t_amb) / O(v)),
                ...
                (n.adFlame = o(
                  ((e, t, n, o) => {
                    void 0 === n && (n = a.tAmb), void 0 === o && (o = 0);
                    const r = d.filter((t) => t.Formula in e),
                      s = C(d.filter((e) => "O2" == e.Formula)[0]),
                      u = C(d.filter((e) => "N2" == e.Formula)[0]),
                      l = C(d.filter((e) => "CO2" == e.Formula)[0]),
                      i = C(d.filter((e) => "H2O" == e.Formula)[0]),
                      _ = C(d.filter((e) => "SO2" == e.Formula)[0]),
                      c = [];
                    let f = 0;
                    for (const t in e)
                      (c[f] = e[t] * C(r.filter((e) => e.Formula == t)[0])(n)),
                        f++;
                    return (e) =>
                      ((e) =>
                        t.O2 * s(e) +
                ...
                r.info(
                  `Adiabatic flame temp: [${s(n.adFlame)} K] ${k.tempC(
                    n.adFlame
                  )}`
                ),
                u(y),
        ...
        e.exports = {
          convSection: (e, t) => {
            let n = e.tg_sh,
              ...
              a = e.t_in_sh,
              u = e.t_in_conv;
            const l = (e, t = a) => 0.5 * (e + t),
              i = e.m_fluid,
              _ = e.m_flue,
              c = (t, n = t) => e.Cp_fluid(l(t, n)),
              ...
              T =
                Math.PI * b * (1 - y * F) +
                Math.PI * y * (2 * S * (b + S) + F * (b + 2 * S)),
              I = T - M,
              R = N * T * C,
              D = (Math.PI * k ** 2) / 2,
              H =
                (2 / 3) *
                (e.Width_rad * e.Length_rad * e.Height_rad) ** (1 / 3),
              P = (e.Ph2o + e.Pco2) * H,
              x = 3.6,
              B = (e) => (p(e) * x * c(e)) / f(e),
              Q = (e) => (O(e) * x * d(e)) / h(e),
              ...
              K = (e = l(a, u), t = e, n = u) =>
                (((e) => J(e))(n) / R) *
                  (b / k) *
                  (g + 1 / U(e, t) + (k * Math.log(b / k)) / (2 * m(t))) +
                e,
              V = (e, t) => 2.2 * 2.7431452152 * P ** 0.5 * (M / T) ** 0.75;
            let j = (e, t) => (h(e) / b) * 0.33 * Q(e) ** (1 / 3) * L(e) ** 0.6;
            const q = (e, t) => 1 / (1 / (j(e, t) + V()) + $),
              z = 1.36 * m(K(l(u, a), K(l(u, a)))),
              X = S + F / 2,
              Y = (q(l(n, o), K(l(u, a), K(l(u, a)))) / (6 * z * F)) ** 0.5,
              Z = Math.tanh(Y * X) / (Y * X),
              ee = Z * (0.7 + 0.3 * Z),
              te = b + 2 * S,
              ne = ee * (0.45 * Math.log(te / b) * (ee - 1) + 1),
              oe = (e, t) => (q(e, t) * (ne * I + M)) / T,
              ae = (t, n) =>
                ((e, t, n, o) => {
                  const a = t.Lf,
                    r = 1 / t.Nf - t.Tf,
                    s = 0.35 + 0.65 * Math.exp((-0.25 * a) / r),
                    u = t.Pitch_sh_cnv,
                    l = t.Pitch_sh_cnv,
                    i = t.N_conv / t.Tpr_sh_cnv,
                    _ =
                      0.7 +
                      (0.7 - 0.8 * Math.exp(-0.15 * i ** 2)) * Math.exp(-u / l),
            ...
            j = (e, t) => ae(e, t) * G * d(e) * Q(e) ** -0.67;
            const re = (e) => r(e, a, n, o),
              se = (e, t) => (b / k) * (1 / U(e, t) + g),
              ue = (e) => (b * Math.log(b / k)) / (2 * m(e)),
              le = (e, t) => 1 / oe(e, t),
              ie = (e, t, n) =>
                1 / ((e, t, n) => le(e, n) + ue(n) + se(t, n))(e, t, n),
              _e = (e, t) => _ * d(e, t) * (e - t),
              ce = (e, t, n) => ie(l(n, t), l(e), K(l(e), K(l(e)))) * R * re(e),
      ...
      623: (e, t, n) => {
        const { newtonRaphson: o, logger: a, round: r, unitConv: s } = n(170),
          u = (e) => {
            const t = {
        ...
        e.exports = {
          radSection: (e, t) => {
            ...
            const m = e.t_air,
              ...
              D = (b / 2) * S * w,
              H = ((e) => {
                const t = s.m2toft2(e.Pitch_sh_cnv * e.Tpr_sh_cnv * e.L_shld),
                ...
                ((e, t, n, o, a, r) => {
                  const { Aw_aAcp: s } = l(t, n, o, a, r),
                    ...
                    c =
                      (e, t = _) =>
                      (n) =>
                        t.a[e] * n ** 3 + t.b[e] * n ** 2 + t.c[e] * n + t.d[e],
                    d = c("A"),
                    f = c("B"),
                    m = c("C");
              ...
              E = e.duty_rad_dist || 0.7,
              G = e.efficiency || 0.8,
              L = e.heat_loss_percent || 0.015,
              U = e.NCV,
              J = e.m_fluid,
              K = (t = c) => e.m_flue_ratio * t,
              V = e.Cp_fuel($(h, p)),
              j = e.Cp_air($(m, p)),
              ...
              ae = (e, t = e, n = f) =>
                (n / I) *
                  (N / v) *
                  (g + 1 / oe(e, t) + (v * Math.log(N / v)) / (2 * Y(t))) +
                e,
              re = (t) => ((t = c) => e.m_air_ratio * t)(t) * j * (m - p),
              se = (e) => e * V * (h - p),
              ue = (e) => e * U,
              le = (e) => ue(e) + re(e) + se(e),
            ...
            if (0 !== _) {
              ...
              t || a.debug(`"mass_fuel_seed", "value": "${u}"`),
                (u = o(s, u, e.NROptions, "M-fuel_T-seed_radiant", t)),
                u && (c = u),
                (f = me(n, ae($(_), ae($(_)))));
            } else {
              (d = ue(c) * G),
            ...
            t ||
              a.default(
                `RADI, T_in_calc: ${e.units.tempC(
                  i
                )}, M_fuel: ${e.units.mass_flow(c)}, Tg_out: ${e.units.tempC(
                  n
                )}`
              ),
              (e.t_in_rad = i),
            ...
            return (Oe.miu_flue = e.miu_flue(n)), (Oe.miu_fluid = Z($(_))), Oe;
          },
        };
      },
      16: (e, t, n) => {
        ...
        e.exports = {
          shieldSection: (e, t) => {
            let n = e.tg_rad,
              u = 0,
              l = e.t_in_rad,
              i = 0.5 * (e.t_in_rad + e.t_in_conv),
              _ = 0;
            const c = (e, t = l) => 0.5 * (e + t),
              d = e.m_fluid,
              f = e.m_flue,
              m = (t, n = t) => e.Cp_fluid(c(t, n)),
              ...
              B = (e, t = e) =>
                ...
                (g(e) / g(t)) ** 0.14,
              Q = (e) => 0.092 * e - 34,
              W = (e) => ($(e) / v) * 0.33 * R(e) ** (1 / 3) * x(e) ** 0.6,
              E = (e, t = n) => 1 / (1 / (W(c(e, t)) + Q(c(e, t))) + b),
              G = (e) => d * m(e) * (l - e),
              L = (e, t = e, n = i) =>
                (G(n) / F) *
                  (v / y) *
                  (k + 1 / B(e, t) + (y * Math.log(v / y)) / (2 * O(t))) +
                e,
              U = (e, t) => v / (y * B(e, t)) + (v / y) * k,
              J = (e) => (v * Math.log(v / y)) / (2 * O(e)),
              K = (e, t = n) => 1 / E(e, t),
              V = (e, t, n, o) =>
                1 / ((e, t, n, o) => K(e, t) + J(o) + U(n, o))(e, t, n, o),
              j = e.q_rad_sh,
              q = (e, t, n, o, a) => V(n, t, o, a) * F * r(e, l, t, n),
            ...
            const ne = (e) =>
              Math.abs(
                (Y(n, e) - q(i, n, e, c(i), L(c(i), L(c(i))))) / Y(n, u)
              );
            for (; ne(u) - 0.001 > 0; ) {
              if (!_) {
              ...
              if (
                ...
                (u = o(Z, n - 58, e.NROptions, "Tg_out_shield-2", !0)),
                te++,
                te > 35)
              ) {
                a.debug(
                  `"Tin_shield",  "t_in_sh_calc": ${s(_)}, "t_in_sh_sup": ${s(
                    i
                  )}`
                ),
            ...
            return (
              t ||
                a.default(
                  `SHLD, cycles: ${te}, T_in_calc: ${e.units.tempC(
                    i
                  )}, Tg_out: ${e.units.tempC(u)}`
                ),
              (e.t_in_sh = i),
              (e.tg_sh = u),
              {
                m_flue: f,
                t_in_sup: 0.5 * (e.t_in_rad + e.t_in_conv),
                t_in: i,
                t_out: l,
                Tb: c(i),
                Tw: L(c(i), L(c(i))),
          ...
          optionsModifier: (e, t, n) => {
            ...
            switch (e) {
              ...
              case "date":
                ...
                break;
              case "heat_loss":
                (r = parseFloat(t[e])), r <= 15 && (n.hLoss = 0.01 * r);
                break;
              case "efficiency":
                (r = parseFloat(t[e])), r >= 50 && (n.effcy = 0.01 * r);
                break;
              case "rad_dist":
                (r = parseFloat(t[e])),
                  r >= 40 && ((n.radDist = 0.01 * r), (n.runDistCycle = !1));
                break;
              case "rfi":
              ...
              case "rfo":
                ...
                break;
              case "t_fuel":
                (r = parseFloat(t[e])), r >= 0 && r && (n.tFuel = a.FtoK(r));
                break;
              case "unit_system":
                o.debug(`"${e}", "value":"${t[e]}"`), (n.unitSystem = t[e]);
                break;
              default:
                ((e, t, n) => {
                  let o;
                  ...
                  ((e, t, n) => {
                    ...
                    switch (e) {
                      case "m_fluid":
                        (o = parseFloat(t[e])),
                          o > 0 && o < 175 && (n.mFluid = a.BPDtolb_h(1e3 * o));
                        break;
                      case "t_in":
                  ...
                  ((e, t, n) => {
                    ...
                    switch (e) {
                      case "t_amb":
                        (o = parseFloat(t[e])), o < 100 && (n.tAir = a.FtoK(o));
                        break;
                      case "humidity":
                        (o = parseFloat(t[e])),
                      ...
                      case "p_atm":
                        (o = parseFloat(t[e])),
                          o > 0.001 && o < 2 && (n.pAtm = o * n.pAtmRef);
                        break;
                      case "air_excess":
                        (o = parseFloat(t[e])),
                          o >= 0 && o <= 300 && (n.airExcess = 0.01 * o);
                        break;
                      case "o2_excess":
                        (o = parseFloat(t[e])),
                          o >= 0 && o <= 30 && (n.o2Excess = 0.01 * o);
                    }
                  })(e, t, n);
            }
          },
          ...
          stringConvResult: (e, t, n) => {
            ...
            return (
              ...
              (s += `\n\n  t_in:     ${r.tempC(t.t_in)}\n  t_out:    ${r.tempC(
                ...
                Math.log(Math.abs(t.DeltaA / t.DeltaB))
              )}\n\n  Q_flue:   ${r.heat_flow(
                t.Q_flue
              )}\n  Q_conv:   ${r.heat_flow(
                t.Q_conv
              ...
              (s =
                "es" == e
                  ? `\nDatos de entrada\n  (en caso de no haber sido introducidos, el \n    simulador tomará los valores predeterminado)\n\n  Sistema de unidades:      ${
                      t.debug_data.unitSystem
                    }\n  Presión atmosférica:      ${
                      t.debug_data.atmPressure
                    }\n  Temperatura ref:          ${
                      t.debug_data.ambTemperature
                    }\n  Temperatura aire:         ${
                      t.debug_data.airTemperature
                    }\n  Temperatura comb:         ${
                      t.debug_data.fuelTemperature
                    }\n\n  Humedad:                  ${o(
                      t.debug_data["humidity_%"],
                      3
                    )} %\n  N2 en aire seco:          ${
                      ...
                      t.debug_data.dryAirPressure
                    }\n  Presión de vapor de agua:  ${
                      t.debug_data.waterPressure
                    }\n\n  Fracción parcial de H2O: ${
                      t.debug_data["H2OPressure_%"]
                    } ÷10²\n  Fracción parcial de N2: ${
                      t.debug_data["N2Pressure_%"]
                    } ÷10²\n  Fracción parcial de O2: ${
                      t.debug_data["O2Pressure_%"]
                    } ÷10²\n  Cont. húmedo (w):   ${
                      t.debug_data.moisture
                    }-AireSeco\n\n\n  Temp. entrada residuo: ${r.tempC(
                      t.conv_result.t_in_given
                    )}\n  Temp. salida residuo:  ${r.tempC(
                      t.rad_result.t_out
                    )}\n\n  Cp(Tb) residuo: ${
                      t.debug_data.cpFluidTb
                    }\n\n  Gravedad esp, residuo: ${
                      t.debug_data.spGrav
                    }\n  Flujo másico, residuo: ${r.mass_flow(
                      t.rad_result.m_fluid
                    )}\n\n  Flujo másico, comb.:   ${r.mass_flow(
                      t.rad_result.m_fuel
                    )}   \n  Flujo másico, gases:   ${r.mass_flow(
                      t.shld_result.m_flue
                    )} \n\n  Calor requerido: ${r.heat_flow(
                      t.rad_result.duty_total
                    )}\n  Calor calculado: ${r.heat_flow(
                      t.rad_result.duty +
                        t.shld_result.duty +
                        t.conv_result.duty
                    )}\n\n  Eficiencia del horno: ${o(
                      t.rad_result.eff_total,
                      2
                    )}% [Q_rls/Q_fluid]\n\n\nMoles de gases de combustión total y porcentajes\npor cada mol de combustible\n\n  Flujo total: ${o(
                      t.flows.total_flow,
                      3
                    )}\n  Flujo seco:  ${o(
                      t.flows.dry_total_flow,
                      3
                      ...
                      t.products.H2O
                    }             H2O: ${o(t.flows["H2O_%"], 3)} %\n  CO2:  ${
                      t.products.CO2
                    }             CO2: ${o(t.flows["CO2_%"], 3)} %\n  SO2:  ${
                      t.products.SO2
                    }             SO2: ${
                      t.flows["SO2_%"] || "0.000"
                    } %\n\n  Exceso de aire usado: ${o(
                      t.flows["air_excess_%"],
                      3
                    )} %\n  Moles O2 req./mol de comb. (teórico): ${o(
                      t.flows.O2_mol_req_theor,
                      3
                    )}\n\n  Rel. A/C molar húmeda:  ${o(
                      t.flows.AC,
                      3
                    )}\n  Rel. A/C másica húmeda: ${o(
                      t.flows.AC_mass,
                      3
                    )}\n  Rel. A/C molar (aire seco, teórica):    ${o(
                      t.flows.AC_theor_dryAir,
                      3
                    )}\n  Rel. A/C másica (aire húmedo, teórica): ${o(
                      t.flows.AC_mass_theor_moistAir,
                      3
                    )}\n\n  Peso molecular del comb. ${
                      t.flows.fuel_MW
                    }\n  Cp(t_comb) del comb.  ${t.flows.Cp_fuel}\n  NCV: ${
                      t.flows.NCV
                    }\n\n  Peso mol. de los gases de comb. ${
                      t.flows.flue_MW
                    }\n  Cp(t_amb) de los gases de comb. ${t.flows.Cp_flue}\n`
                  : `\nInput Data \n  (in case of no input, \n  default values will be taken)\n\n  Unit System:          ${
                      ...
                      t.debug_data.moisture
                    }-dryAir\n\n\n  Fluid's Inlet Temp.:  ${r.tempC(
                      t.conv_result.t_in_given
                    )}\n  Fluid's outlet Temp.: ${r.tempC(
                      t.rad_result.t_out
                    )}\n\n  Fluid's Cp(Tb):    ${
                      t.debug_data.cpFluidTb
                    }\n\n  Fluid's Sp Grav:   ${
                      t.debug_data.spGrav
                    }\n  Fluid's Mass Flow: ${r.mass_flow(
                      t.rad_result.m_fluid
                    )}\n\n  Comb's  Mass Flow: ${r.mass_flow(
                      t.rad_result.m_fuel
                    )}   \n  Gases's Mass Flow: ${r.mass_flow(
                      t.shld_result.m_flue
                    )} \n\n  Fluid heat required: ${r.heat_flow(
                      t.rad_result.duty_total
                    )}\n  Heat calculated:     ${r.heat_flow(
                      t.rad_result.duty +
                        t.shld_result.duty +
                        t.conv_result.duty
                    )}\n  \n  Heater Efficiency: ${o(
                      ...
                      t.flows["air_excess_%"],
                      3
                    )} %\n  Moles O2 required/fuel-mol (theor): ${o(
                      t.flows.O2_mol_req_theor,
                      3
                    )}\n\n  A/C molar moist relation:   ${o(
                      t.flows.AC,
                      3
                    )}\n  A/C mass moist relation:    ${o(
                      t.flows.AC_mass,
                      3
                    )}\n  A/C molar relation (dry air, theor):   ${o(
                      t.flows.AC_theor_dryAir,
                      3
                    )}\n  A/C mass relation (moist air, theor):  ${o(
                      t.flows.AC_mass_theor_moistAir,
                      3
                    )}\n\n  Fuel mol weight: ${
                      t.flows.fuel_MW
      ...
      170: (e) => {
        const t = (...e) => {
            let t = "" + e[1][0];
            for (var n = 1; n < e[1].length; n++) t += " " + e[1][n];
            switch (e[0]) {
              case "DEBUG":
                _.verbose && console.debug(JSON.parse(`{"${e[0]}": ${t}}`));
                break;
              case "INFO":
          ...
          i = {
            ...
            hcENtohcSI: (e) => ((1.05506 * e) / (5 / 9)) * 3.28084 ** 2,
          ...
          _ = (() => {
            ...
            return (
              "undefined" == typeof process ||
                ...
                (e.tAmb = o + parseFloat(process.argv[4]) || l),
                (e.humidity = parseFloat(process.argv[5]) || 0),
                (e.o2Excess = 0.01 * parseFloat(process.argv[6]) || 0),
                (e.airExcess = 0.01 * parseFloat(process.argv[7]) || 0),
                (e.pAtm = parseFloat(process.argv[8]) || 101325),
                (e.NROptions.verbose = "true" == process.argv[2])),
              e
            );
          })();
        _.verbose && n.debug(`"options","args":${JSON.stringify(_, null, 2)}`);
        const c = (e, t = 3) => (Math.round(e * 10 ** t) / 10 ** t).toFixed(t),
          d = (e, t, o) => {
            const a = { ...e },
              r = Object.values(a).reduce((e, t) => e + t);
            for (const e in a) a[e] = a[e] / r;
            return (
              o || n.debug(`"normalize", "name": "${t}", "total": ${r}`), a
            );
          },
          f = ({ k0: e, k1: t, k2: o, Substance: a }) =>
            0 == e || "-" == e
              ? (n.debug(`"Thermal Cond func called for '${a}' without coffs"`),
                () => 0)
              : (n) => 3.6 * (e + t * n + o * n ** 2),
          m = ({ u0: e, u1: t, u2: o, Substance: a }) =>
            0 == e || "-" == e
              ? (n.debug(`"Viscosity func called for '${a}' without coffs"`),
                () => 0)
              : (n) => e + t * n + o * n ** 2,
          h = {
            ...
            heat_flux: (e) => c(i.kJtoBTU(e) / i.mtoft(1) ** 2) + " Btu/h-ft²",
            fouling_factor: (e) =>
              c((10.763910417 * e * 1.8) / 0.94781712) + " h-ft²-°F/Btu",
            "energy/mass": (e) => c(i.kJtoBTU(e) / i.kgtolb(1)) + " Btu/lb",
            "energy/vol": (e) => c(i.kJtoBTU(e) / i.mtoft(1) ** 3) + " Btu/ft³",
            ...
            pressure: (e) => c(0.0001450377 * e) + " psi",
            mass: (e) => c(0.0022046244202 * e) + " lb",
            mass_flow: (e) => c(i.kgtolb(e)) + " lb/h",
            barrel_flow: (e) =>
              c(i.kgtolb(e) / i.BPDtolb_h(1) / 1e3) + " x10³ BPD",
            vol_flow: (e) => c(e * i.mtoft(1) ** 3) + " ft³/h",
            cp: (e) => c(0.238845896627 * e) + " Btu/lb-°F",
            cp_mol: (e) => c(0.238845896627 * e) + " Btu/lb-mol-°F",
            power: (e) => c(3.4121416331 * e) + " Btu/h",
            moist: (e) => c(1e3 * e) + " ÷10³ lb-H2O/lb",
            thermal: (e) =>
              c((e * i.kJtoBTU(1)) / i.KtoR(1) / i.mtoft(1)) + " BTU/h-ft-°F",
            convect: (e) =>
              c((e * i.kJtoBTU(1)) / i.KtoR(1) / i.mtoft(1) ** 2) +
              " BTU/h-ft²-°F",
        ...
        e.exports = {
          ...
          newtonRaphson: (e, t, o, a, r, s) => {
            ...
            const h = a || {},
              ...
              $ = void 0 === h.h ? 1e-4 : h.h,
              g = 1 / $,
              C = void 0 === h.maxIterations ? 20 : h.maxIterations;
            for (_ = 0; _++ < C; ) {
              if (
                ((l = e(o)),
                t
              ...
              if (((u = o - l / i), Math.abs(u - o) <= p * Math.abs(u)))
                return (
                  s ||
                    n.debug(
                      `"Newton-Raphson", "func":"${r}", "var converged to":${u}, "iterations":${_}`
                    ),
                  u
                );
              o = u;
            ...
            return (
              n.error(
                `Newton-Raphson (${r}): Maximum iterations reached (${C})`
              ),
              !1
            );
          },
          ...
          linearApprox: ({ x1: e, x2: t, y1: o, y2: a }) => {
            if ("number" != typeof o)
              return (
                n.error(
                  `call for linearApprox with incorrect value type for y1: ${o}`
                ),
                () => 0
              );
            if (e == t || null == t || null == a) return () => o;
            const r = (a - o) / (t - e);
            return (t) => r * (t - e) + o;
          },
          viscosityApprox: ({ t1: e, t2: t, v1: o, v2: a }) => {
            if ("number" != typeof o)
              return (
                n.error(
                  `call for viscosityApprox with incorrect value type for v1: ${o}`
                ),
                () => 0
              );
            if (e == t || null == t || null == a) return () => o;
          ...
          initSystem: (e) => {
            if ("string" != typeof e)
              return (
                _.verbose &&
                  n.warn(
                    `invalid type (${e}) for unit system, using default SI`
                  ),
                p
              );
            switch (e.toLowerCase()) {
              ...
              default:
                return (
                  n.warn(
                    e.toLowerCase() + " - invalid unit system, using default SI"
                  ),
                  p
                );
            }
          ...
          kw_tubes_A312_TP321: (e) => {
            const t = e - o;
            return 3.6 * (14.643 + 0.0164 * t + -2e-6 * t ** 2);
          },
          LMTD: (e, t, n, o, a) => {
            let r = n - t,
              s = o - e;
  ...
  (() => {
    const {
      ...
      { radSection: c } = n(623),
      { convSection: d } = n(399),
      { shieldSection: f } = n(16),
      { combSection: m } = n(911),
      { browserProcess: h } = n(620),
      p = (e, t) => {
        const n = ((e) => {
          const t = a.lbtokg(e.mFluid),
            n = a.FtoK(e.tIn),
            o = a.FtoK(e.tOut),
            u = a.CpENtoCpSI(0.676),
            _ = a.CpENtoCpSI(0.702),
            c = a.kwENtokwSI(0.038),
            d = a.kwENtokwSI(0.035);
          return {
            runDistCycle: e.runDistCycle,
            p_atm: e.pAtm,
            t_fuel: e.tFuel,
            t_air: e.tAir,
            t_amb: e.tAmb,
            humidity: e.humidity,
            airExcess: e.airExcess,
            o2Excess: e.o2Excess,
            sp_grav: e.spGrav,
            t_in_conv: n,
            t_out: o,
            m_fluid: t,
            Rfi: a.RfENtoRfSI(e.rfi),
            Rfo: a.RfENtoRfSI(e.rfo),
            Rfi_conv: 0,
            Rfi_shld: 0,
            Rfo_shld: 0,
            efficiency: e.effcy,
            duty_rad_dist: e.radDist,
            heat_loss_percent: e.hLoss,
            ...
            Cp_fluid: s({ x1: a.FtoK(678), y1: u, x2: a.FtoK(772), y2: _ }),
            kw_fluid: s({ x1: a.FtoK(678), y1: c, x2: a.FtoK(772), y2: d }),
            Material: "A-312 TP321",
            h_conv: a.hcENtohcSI(1.5),
            kw_tube: i,
            Pass_number: 2,
            Pitch_rad: a.intom(16),
            N_rad: 42,
            L_rad: a.fttom(62.094),
            Do_rad: a.intom(8.625),
            Sch_rad: a.intom(0.322),
            Burner_number: 13,
            Do_Burner: 2.24,
            Width_rad: 17.5,
            Length_rad: 64.55,
            ...
            N_shld: 16,
            L_shld: a.fttom(60),
            Do_shld: a.intom(6.625),
            Pitch_sh_cnv: a.intom(12),
            Sch_sh_cnv: a.intom(0.28),
            Tpr_sh_cnv: 8,
            N_conv: 40,
            L_conv: a.fttom(60),
            Do_conv: a.intom(6.625),
            Nf: a.mtoft(60),
            Tf: a.fttom(0.005),
            Lf: a.fttom(0.08),
            FinType: "Solid",
