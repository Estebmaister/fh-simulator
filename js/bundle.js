(() => {
  var t = {
    620 : (t, e, s) => {
      const {compactResult : n} = s(851), {outputFullData : l} = s(669),
                             {graphicData : a} = s(566),
      ...
      t.exports = {
        browserProcess : (t, e, s, u) => {
          ...
          d.length > 0 &&
              d.forEach((t => {"es" != t && "es_graph" != t || (c = "es")})),
              s.lang = c;
          const _ = (t => {
            if ("" == t)
              return {};
          ...
          if (_ !== {} &&
                  (t = ((t, e, s, n) => {
                     const l = {}, a = s.filter((e => e.Formula in t));
                     for (const e in t)
                       if (1 === a.filter((t => t.Formula == e)).length &&
                           "" !== t[e]) {
                         ...
                         "" !== t[e] && void 0 !== t[e] && r(e, t, n);
                     return 0 !== Object.keys(l).length && (e = l), e
                   })(_, t, e, s)),
              d[1].includes("_graph") || d[2].includes("_graph"))
            a(u, t, s);
          else if (d.includes("fullResult") || d.includes("fullResult.html")) {
            const e = u(t, s);
    ...
    851 : (t, e, s) => {
      const {stringCompactResult : n} = s(144), {logger : l} = s(170);
      t.exports = {
          ...
          localStorage.setItem(`${s.title}`,
              ...
              "base" === s.title
                  ? (u = s, r = a,
                     ...
                     i = c ? c.opt : {}, o = c ? c.result : {})
                  : (i = s, o = a, c = JSON.parse(localStorage.getItem("base")),
                     c || (c = {result : t(e, l), opt : l}), u = c ? c.opt : {},
                     r = c ? c.result : {});
    ...
    566 : (t, e, s) => {
      ...
      t.exports = {
        graphicData : (t, e, s) => {
          const a = {...n};
          n.error = () => 0, n.default = () => 0, n.info = () => 0,
          n.debug = () => 0, s.unitSystem = "english";
          const r = [];
          let o, u, i = JSON.parse(localStorage.getItem(`${s.title}_graph`));
          if (i && (o = i[`${window.location.search}`],
          ...
          case "o2_excess":
            ...
            break;
          case "m_fluid":
            u = "mFluid", s.graphRange *= 1e5;
            break;
          default:
            u = "tOut", s.graphRange *= 100
          }
          const c = s.graphPoints, d = s.graphRange;
          let _ = s[u] - d / 2;
          _ < 0 && (_ = 0),
              a.info(
          ...
          for (let n = 0; n < c; n++) {
            ...
            const a = t(e, s);
            r[n] = {
              m_fluid : .001 * l.lb_htoBPD(l.kgtolb(a.rad_result.m_fluid)),
              t_out : l.KtoF(a.rad_result.t_out),
              o2_excess : a.flows["O2_%"] < 11 ? a.flows["O2_%"] : 11,
              air_excess : a.flows["air_excess_%"] > 0 ? a.flows["air_excess_%"]
                                                       : 0,
              ...
              efficiency : a.rad_result.eff_thermal_val
                               ...
                               : 0,
              rad_dist : a.rad_result["%"] < 1
                             ? Math.round(1e5 * a.rad_result["%"]) / 1e3
                             : 0,
              cnv_dist : a.conv_result["%"] < 1
                             ? Math.round(1e5 * a.conv_result["%"]) / 1e3
                             : 0,
              co2_emiss :
                  Math.round(100 * a.products.CO2 * (44.01 / a.flows.fuel_MW) *
          ...
          i || (i = {}),
              ...
              localStorage.setItem(`${s.title}_graph`, JSON.stringify(i)),
              console.log(r), draw(r, s)
        }
      }
    },
    144 : (t, e, s) => {
      ...
      t.exports = {
        stringRadResult : (t, e, s) => {
          ...
          return r = "es" == t ? "Resultados sección radiante:"
                 ...
                 r += `\n\n  t_in:     ${a.tempC(e.t_in)}\n  t_out:    ${
                     ...
                     a.tempC(e.Tw)}\n\n  tg_out:   ${
                     a.tempC(e.tg_out)}\n\n  rfi:      ${
                     a.fouling_factor(e.rfi)}\n\n  Q_in:     ${
                     a.heat_flow(e.Q_in)}\n    Q_rls:    ${
                     a.heat_flow(e.Q_rls)}\n    Q_air:    ${
                     a.heat_flow(e.Q_air)}\n    Q_fuel:   ${
                     a.heat_flow(e.Q_fuel)}\n\n  Q_out:    ${
                     a.heat_flow(e.Q_out)}\n    Q_flue:   ${
                     a.heat_flow(e.Q_flue)}\n    Q_losses: ${
                     a.heat_flow(e.Q_losses)}\n    Q_shld:   ${
                     a.heat_flow(e.Q_shld)}\n    Q_R:      ${
                     a.heat_flow(e.Q_R)}\n      Q_conv: ${
                     a.heat_flow(e.Q_conv)}\n      Q_rad:  ${
                     a.heat_flow(e.Q_rad)}\n    Q_fluid:  ${
                     a.heat_flow(e.Q_fluid)}\n\n  duty_rad:   ${
                     n(100 * e["%"],
                       2)}%\n\n  At:       ${a.area(e.At)}\n  Ar:       ${
                     a.area(e.Ar)}\n  Acp:      ${a.area(e.Acp)}\n  αAcp:     ${
                     a.area(
                     ...
                     a.convect(
                         e.h_conv)}\n\n  MBL:      ${e.MBL} ft\n  GPpres:   ${
                     n(1 * e.Pco2 + 1 * e.Ph2o)} atm\n  PL:       ${
                     e.PL} atm-ft\n  GEmiss:   ${e.emiss}\n  F:        ${
                     e.F}\n\n  kw_tube:  ${a.thermal(e.kw_tube)}\n  kw_fluid: ${
                     a.thermal(e.kw_fluid)}\n  kw_flue:  ${
                     a.thermal(e.kw_flue)}\n\n  miu_fluid:${
                     a.viscosity(e.miu_fluid)}\n  miu_flue: ${
                     a.viscosity(e.miu_flue)}\n\n  Cp_fluid: ${
                     a.cp(e.Cp_fluid)}\n  Cp_flue:  ${
                     a.cp(e.Cp_flue)}\n\n  Cp_fuel:  ${
                     a.cp(e.Cp_fuel)}\n  Cp_air:   ${
                     a.cp(e.Cp_air)}\n  Pr_fluid: ${e.Prandtl}\n  Re_fluid: ${
                     ...
                     e.TUBING.Nt}\n    No Tubes:       ${
                     e.TUBING.N}\n    Wall Thickness: ${
                     a.lengthC(e.TUBING.Sch)}\n    Outside Di:     ${
                     a.lengthC(e.TUBING.Do)}\n    Pitch:          ${
                     a.lengthC(e.TUBING.S_tube)}\n    Ef. Length:     ${
                     a.length(e.TUBING.L)}\n\n  `,
                 "\n" + r
        },
        stringShldResult : (t, e, s) => {
          ...
          return r = "es" == t ? "Resultados sección de escudo:"
                 ...
                 r += `\n\n  t_in:     ${a.tempC(e.t_in)}\n  t_out:    ${
                     ...
                     a.tempC(e.tg_out)}\n\n  rfi:      ${
                     a.fouling_factor(e.rfi)}\n  rfo:      ${
                     a.fouling_factor(e.rfo)}\n\n  LMTD:     ${
                     a.temp(e.LMTD)}\n  DeltaA:     ${
                     a.temp(e.DeltaA)}\n  DeltaB:     ${
                     a.temp(e.DeltaB)}\n  DeltaA-B:   ${
                     a.temp(e.DeltaA - e.DeltaB)}\n  Log(A/B):   ${
                     n(Math.log(e.DeltaA / e.DeltaB))}\n\n  Q_flue:   ${
                     a.heat_flow(
        ...
        stringConvResult : (t, e, s) => {
          ...
          return r = "es" == t ? "Resultados sección convectiva:"
                 ...
                 r += `\n\n  t_in:     ${a.tempC(e.t_in)}\n  t_out:    ${
                     ...
                     e.FINING.Material}\n    Type:       ${
                     e.FINING.Type}\n    Height:     ${
                     a.lengthC(e.FINING.Height)}\n    Thickness:  ${
                     a.lengthC(e.FINING.Thickness)}\n    Dens:       ${
                     a.lengthInv(e.FINING.Dens)},\n    Arrange:    ${
                     e.FINING.Arrange}\n  `,
                 "\n" + r
        },
        stringCombResult : (t, e, s) => {
          ...
          return r = "es" == t
                         ? `\nDatos de entrada\n  (en caso de no haber sido introducidos, el\n  simulador selecciona los valores predeterminados)\n\n  Sistema de unidades:         ${
                               ...
                               e.flows
                                   .Cp_flue}\n\n  Emisiones de CO2 (t/año): ${
                               n(44.01 * e.products.CO2 / e.flows.fuel_MW *
                         ...
                         : `\nInput Data\n  (Default values will be taken in case\n    of no entries)\n\n  Unit System:           ${
                               ...
                               a.mass_flow(e.rad_result.m_fuel,
                                           1)}\n  Flue Gas Mass Flow:       ${
                               a.mass_flow(e.shld_result.m_flue,
                                           1)}\n  Combustion Air Mass Flow: ${
                               a.mass_flow(e.rad_result.m_air,
                                           1)}\n\n  Fuel MW:             ${
                               a["mass/mol"](
                                   e.flows.fuel_MW)}\n  Fuel Sp. Heat, Cp:   ${
                               e.flows
        ...
        stringCompactResult : (t, e, s, a = {}, r = {}) => {
          ...
          return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
              ...
              u.heat_flow(e.conv_result.Q_stack)} - ${
              n(100 * e.conv_result.Q_stack / e.rad_result.Q_in,
                2)}% del total</td>\n    <td class="tg-simple">${
              o ? u.heat_flow(a.conv_result.Q_stack) + " - " +
                      n(100 * a.conv_result.Q_stack / a.rad_result.Q_in, 2) +
                      "% del total"
                : ""}</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Pérdidas de calor al ambiente</td>\n    <td class="tg-simple">${
              u.heat_flow(e.rad_result.Q_losses)} - ${
              n(100 * e.rad_result.Q_losses / e.rad_result.Q_in,
                2)}% del total</td>\n    <td class="tg-simple">${
              o ? u.heat_flow(a.rad_result.Q_losses) + " - " +
                      n(100 * a.rad_result.Q_losses / a.rad_result.Q_in, 2) +
                      "% del total"
                : ""}</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Eficiencia Térmica NHV (API-560)</td>\n    <td class="tg-simple">${
              n(e.rad_result.eff_total, 2)} %</td>\n    <td class="tg-simple">${
              o ? n(a.rad_result.eff_total, 2) + " %"
                : ""}</td>\n  </tr>\n  <tr>\n    <td class="tg-simple">▪ Eficiencia Térmica GHV (API-560)</td>\n    <td class="tg-simple">${
              n(e.rad_result.eff_thermal_val,
                2)} %</td>\n    <td class="tg-simple">${
    ...
    911 : (t, e, s) => {
     ...
     f =
          (t, e = {}) => {
            ...
            return n || (e.err += `[fuel fraction not equal to 1, total: ${
                             s}. fuels: ${Object.keys(t)}],`),
                   n
          },
     p = ({c0 : t, c1 : e, c2 : s, c3 : n, MW : l, Substance : o}, u, i) => c =>
          (c < 250 && !i &&
               a.debug(`"Cp0", "temp": ${r(c)},"Msg": "${
                   o} bellow range for Cp0 formula"`),
           c > 1200 && !i &&
               a.debug(`"Cp0", "temp": ${r(c)},"Msg": "${
                   o} above range for Cp0 formula"`),
           "-" === t
               ? (a.debug(`"Cp0", "Msg": "Wrong use, called for compound ${
                      o}, no data found"`),
                  0)
           : u ? l * (t + e * (.001 * c) + s * (.001 * c) ** 2 +
                      n * (.001 * c) ** 3)
               : t + e * (.001 * c) + s * (.001 * c) ** 2 +
                     n * (.001 * c) ** 3),
     h =
          (t, e, s) => {
            ...
            const l = _.filter((t => t.Formula in n)), a = [];
            let r = 0;
            for (const t in n)
              a[r] = s => n[t] * p(l.filter((e => e.Formula == t))[0], e)(s),
              r++;
            return a.reduce(((t, e) => s => t(s) + e(s)), (t => 0))
          },
     g =
          (t, e) => {
            if (0 === t.length)
     ...
     O = (t, e) =>
          "-" === t.Cp0
              ? "-" === t.h0
                    ? (a.warn(`wrong use of deltaH func, called for compound ${
                           t.Substance} without data`),
                       void 0 === e ? () => 0 : 0)
                : void 0 === e ? () => t.h0
                               : t.h0
          : void 0 === e ? e => t.h0 + (e - l.tempAmbRef) *
                                           p(t, !0, !0)((l.tempAmbRef + e) / 2)
                         : t.h0 + (e - l.tempAmbRef) *
                                      p(t, !0, !0)((l.tempAmbRef + e) / 2),
     b = (t, e, s, n) => {
       const a = O(_[6]), r = O(_[34]), o = O(_[2]);
       let u = O(_[31]);
       return !0 === n && (u = O(_[32])), void 0 === s && (s = l.tAmb),
              void 0 === e ? e => t.CO2 * a(e) + t.SO2 * r(e) + t.H2O * u(e) -
                                  O(t)(s) - t.O2 * o(s)
                           : t.CO2 * a(e) + t.SO2 * r(e) + t.H2O * u(e) -
                                 O(t)(s) - t.O2 * o(s)
     };
      t.exports = {
        combSection : (t, e, s, p) => {
          p || a.debug(`"airExcess", "value": ${t}`);
          const w = u(s.unitSystem), k = {
            err : "",
          ...
          return p ||
                     (s.m_flue_ratio = M * I.flue_MW / g(N),
                      ...
                      s.Pco2 = y.CO2 / M, s.Ph2o = y.H2O / M, s.Cp_air = h(S),
                      s.Cp_fuel = h(N), s.Cp_flue = I.Cp_flue,
                      s.miu_flue = c(_, y), s.kw_flue = d(_, y),
                      ...
                      s.NCV = -((t, e, s, n) => {
                        ...
                        return l
                              ...
                              g(N),
                      I.NCV = w["energy/mass"](s.NCV, 0), I.NCV_val = s.NCV,
                      s.adFlame = n(
                          ((t, e, s, n) => {
                            void 0 === s && (s = l.tAmb),
                                void 0 === n && (n = 0);
                      ...
                      a.info(`Adiabatic flame temp: [${r(s.adFlame)} K] ${
                          w.tempC(s.adFlame)}`),
                      o(y), "" == k.err && delete k.err),
          {
            flows: I, products: y, debug_data: k
          }
        }
      }
    },
    399 : (t, e, s) => {
      const {newtonRaphson : n, logger : l, LMTD : a, round : r, unitConv : o} =
          s(170);
      t.exports = {
        convSection : (t, e) => {
          let s = t.tg_sh, n = 0, o = t.t_in_sh, u = t.t_in_conv, i = 0;
          const c = (t, e = o) => .5 * (t + e), d = t.m_fluid, _ = t.m_flue,
                ...
                $ = e => t.miu_fluid(e), C = e => t.miu_flue(e), O = t.Rfo,
                b = t.Rfi_conv, w = t.L_conv, k = t.Do_conv,
                v = t.Do_conv - 2 * t.Sch_sh_cnv, N = t.Pitch_sh_cnv,
                y = t.N_conv, S = t.Tpr_sh_cnv, A = t.Nf, F = t.Lf, M = t.Tf,
                T = S * N * w - (k + 2 * F * M * A) * w * S,
                I = Math.PI * k * (1 - A * M),
                R = Math.PI * k * (1 - A * M) +
                    Math.PI * A * (2 * F * (k + F) + M * (k + 2 * F)),
                H = R - I, D = y * R * w, P = Math.PI * v ** 2 / 2,
                x = 2 / 3 * (t.Width_rad * t.Length_rad * t.Height_rad) **
                    (1 / 3),
                B = (t.Ph2o + t.Pco2) * x, Q = 3.6,
                W = t => $(t) * Q * m(t) / p(t),
                E = t => C(t) * Q * f(t) / g(t), G = d / Q / P,
                L = t => G * v / $(t), U = _ / T, J = t => U / Q * k / C(t),
                V = (t, e = t) => p(t) / v * .023 * L(t) ** .8 * W(t) **
                                  (1 / 3) * ($(t) / $(e)) ** .14,
                K = (t, e = o) => d * m(t, e) * (e - t),
                q = (t = c(o, u), e = t, s = u) =>
                    (t => K(t))(s) / D * (k / v) *
                    ...
                    t,
                j = (t, e) => 2.2 * 2.7431452152 * B ** .5 * (I / R) ** .75;
          let z = (t, e) => g(t) / k * .33 * E(t) ** (1 / 3) * J(t) ** .6;
          const X = (t, e) => 1 / (1 / (z(t, e) + j()) + O),
                Y = 1.36 * h(q(c(u, o), q(c(u, o)))), Z = F + M / 2,
                tt = (X(c(s, n), q(c(u, o), q(c(u, o)))) / (6 * Y * M)) ** .5,
                et = Math.tanh(tt * Z) / (tt * Z), st = et * (.7 + .3 * et),
                nt = k + 2 * F,
                lt = st * (.45 * Math.log(nt / k) * (st - 1) + 1),
                at = (t, e) => X(t, e) * (lt * H + I) / R,
                rt = (e, s) => ((t, e, s, n) => {
                  const l = e.Lf, a = 1 / e.Nf - e.Tf,
                        r = .35 + .65 * Math.exp(-.25 * l / a),
                        o = e.Pitch_sh_cnv, u = e.Pitch_sh_cnv,
                        i = e.N_conv / e.Tpr_sh_cnv,
                        c = .7 + (.7 - .8 * Math.exp(-.15 * i ** 2)) *
                                     Math.exp(-o / u),
                        d = (2 * e.Lf + e.Do_conv) / e.Do_conv,
                        _ = (t, e) =>
                            t + (e - t) / ((Math.exp(1.4142 * s * n) +
                                            Math.exp(-1.4142 * s * n)) /
                                           2);
                  return e.Ts = _, (e, s) => (e => .25 * t(e) ** -.35)(e) * r *
                                             c * d ** .5 * (e / _(e, s)) ** .25
                })(J, t, tt, Z)(e, s);
          z = (t, e) => rt(t, e) * U * f(t) * E(t) ** -.67;
          const ot = t => a(t, o, s, n),
                ...
                _t = (t, e) => _ * f(t, e) * (t - e),
                mt = (t, e, s) =>
                    dt(c(s, e), c(t), q(c(t), q(c(t)))) * D * ot(t),
                ft = (t, e = .7 * s) => s - K(t) / (_ * f(c(s, e))),
                pt = () => 100 * (mt(i, s, n) - K(i)) / K(i);
          for (n = ft(u), i = u; n - i < 0;)
            i *= 1.002, n = ft(i);
          let ht, gt;
          for (let t = 0; t < 100 && !(Math.abs(pt()) < .001); t++)
            n - i < 0 || pt() <= 0
                ? (ht = i, ht &&gt ? i = (ht + gt) / 2 : i *= 1.001)
                : (gt = i, ht &&gt ? i = (ht + gt) / 2 : i *= .999),
                n = ft(i);
          return u = i,
                 e ||
                     l.default(
                         `CONV, T_in_calc: ${t.units.tempC(i)}, T_in_given: ${
                             t.units.tempC(
                                 t.t_in_conv)}, Tg_stack: ${t.units.tempC(n)}`),
                 t.t_in_conv_calc = u, t.tg_conv = n, {
            t_fin: t.Ts(c(u), q(c(u), q(c(u)))), t_in_given: t.t_in_conv,
                t_in: u, t_out: o, Tb: c(u), Tw: q(c(u), q(c(u))), tg_out: n,
                tg_in: s, Tb_g: c(s, n), rfi: b, rfo: O, LMTD: ot(u),
                DeltaA: s - o, DeltaB: n - u, Q_flue: _t(s, n), Q_fluid: K(u),
                Q_conv: mt(u, s, n), Q_stack: _t(n, t.t_air), duty: K(u),
                "%": K(u) / t.duty, duty_flux: K(u) / D, Cp_fluid: m(u, o),
                Cp_flue: f(s, n), miu_fluid: $(q(c(u))), miu_flue: C(n),
                kw_fluid: p(c(u)), kw_tube: h(q(c(u))), kw_fin: Y,
                kw_flue: g(c(s, n)), Prandtl: r(W(c(o))), Reynolds: r(L(c(o))),
                PrandtlFlue: r(E(c(o))), ReynoldsFlue: r(J(c(o))), At: D, Ai: P,
                An: T, Ao: R, Apo: I, Afo: H, Ef: lt, Gn: U / Q,
                hi: V(c(u), q(c(u), q(c(u)))), hr: j(c(s, n), q(c(u), q(c(u)))),
                ...
                Uo: dt(c(s, n), c(u), q(c(u))), R_int: ut(c(u), q(c(u))),
                R_tube: it(q(c(u))), R_ext: ct(c(s, n), q(c(u))), TUBING: {
                  Material: t.Material,
                  Nt: S,
                  N: y,
                  Sch: t.Sch_sh_cnv,
                 ...
                 o = t => {
                   const e = {
                     ...
                     c : {A : .21258, B : .2258, C : -.047351, D : .004165}
                         ...
                         n = s("A"), l = s("B"), a = s("C"), r = s("D");
                   return e => n(e) + l(e) * t + a(e) * t ** 2 + r(e) * t ** 3
                 }, u = (t, e, s, n, l) => {
                   const a = s * n + t * e, r = l - a;
                   return { Aw: r, Aw_aAcp: r / a }
                 };
      t.exports = {
        radSection : (t, e) => {
          let s = 0, i = 0, c = t.t_out, d = t.m_fuel, _ = 0, m = 0;
          const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                $ = (t, e = i) => .5 * (e + t), C = t.Rfi, O = t.N_rad,
                b = t.N_shld, w = t.L_rad, k = t.L_shld, v = t.Do_rad,
                N = t.Do_rad - t.Sch_rad, y = t.Pitch_rad || .394,
                S = t.Pitch_sh_cnv, A = t.h_conv || 30.66,
                F = 2 / 3 * (t.Width_rad * t.Length_rad * t.Height_rad) **
                    (1 / 3),
                M = (t.Ph2o + t.Pco2) * F,
                T = 1 + y / v * .49 / 6 - .09275 * (y / v) ** 2 +
                    .065 * (y / v) ** 3 / 6 + 25e-5 * (y / v) ** 4,
                I = O * Math.PI * v * w, R = O * y * w, H = b / 2 * S * k,
                D = (t => {
                  const e = r.m2toft2(t.Pitch_sh_cnv * t.Tpr_sh_cnv * t.L_shld),
                        ...
                        o = (t.Width_rad - a) / 2, u = r.mtoft(4 * t.Pitch_rad),
                ...
                B = Math.PI * N ** 2 / 2, Q = 2.04133464e-7,
                W = t => ((t, e, s, n, l, a) => {
                  const {Aw_aAcp : r} = u(e, s, n, l, a), i = o(t), c = {
                ...
                })(M, T, R, 1, H, D)(r.KtoF(t)),
                E = t.duty_rad_dist || .7, G = t.efficiency || .8,
                L = t.heat_loss_percent || .015, U = t.NCV, J = t.m_fluid,
                V = (e = d) => t.m_air_ratio * e,
                K = (e = d) => t.m_flue_ratio * e, q = t.Cp_fuel($(p, h)),
                j = t.Cp_air($(f, h)), z = (e, s = e) => t.Cp_fluid($(e, s)),
                X = (e, s = e) => t.Cp_flue($(e, s)), Y = e => t.kw_fluid(e),
                Z = e => t.kw_tube(e), tt = e => t.miu_fluid(e),
                et = J / 3.6 / B, st = t => tt(t) * z(t) * 3.6 / Y(t),
                nt = t => et * N / tt(t),
                lt = (t, e = t) => Y(t) / N * .023 * nt(t) ** .8 * st(t) **
                                   (1 / 3) * (tt(t) / tt(e)) ** .14,
                at = (t, e = t, s = m) =>
                    s / I * (v / N) *
                        (C + 1 / lt(t, e) + N * Math.log(v / N) / (2 * Z(e))) +
                    t,
                rt = t => V(t) * j * (f - h), ot = t => t * q * (p - h),
                ut = t => t * U, it = t => ut(t) + rt(t) + ot(t),
                ct = (t, e) => K(e) * X(t, h) * (t - h), dt = t => ut(t) * L,
                _t = (t, e) => A * I * (t - e),
                ...
                gt = (t, e) => J * z(e, t) * (t - e);
          if (0 !== c) {
            _ = gt(c, g), m = _ * E, i = g + _ * (1 - E) / (J * z(g, c));
            const a = n((t => gt(c, i) - pt(t, at($(c), at($(c))))), 1e3,
            ...
            e || l.debug(`"mass_fuel_seed", "value": "${o}"`),
                ...
                o && (d = o), m = pt(s, at($(c), at($(c))))
          } else {
            _ = ut(d) * G, m = _ * E, i = g + _ * (1 - E) / (J * z(g));
            let a = g + _ / (J * z(i));
            const r = n((t => it(d) - ht(t, d, at($(a), at($(a))))), 1e3,
                        t.NROptions, "Tg_mFuel-seed_radiant", e);
            r && (s = r),
                a = n((t => gt(t, i) - pt(s, at($(t), at($(t))))), a,
          ...
          e || l.default(`RADI, T_in_calc: ${t.units.tempC(i)}, M_fuel: ${
                   t.units.mass_flow(d)}, Tg_out: ${t.units.tempC(s)}`),
              t.t_in_rad = i, t.t_out = c, t.tg_rad = s, t.duty = _,
              t.m_flue = K(d), t.m_air = V(d), t.t_w_rad = at($(c), at($(c))),
    ...
    16 : (t, e, s) => {
      ...
      t.exports = {
        shieldSection : (t, e) => {
          let s = t.tg_rad, o = 0, u = t.t_in_rad,
              i = .5 * (t.t_in_rad + t.t_in_conv), c = 0;
          const d = (t, e = u) => .5 * (t + e), _ = t.m_fluid, m = t.m_flue,
                f = (e, s = e) => t.Cp_fluid(d(e, s)),
                p = (e, s = e) => t.Cp_flue(d(e, s)), h = e => t.kw_fluid(e),
                g = e => t.kw_tube(e), $ = e => t.kw_flue(e),
                C = e => t.miu_fluid(e), O = e => t.miu_flue(e), b = t.Rfo_shld,
                w = t.Rfi_shld, k = t.N_shld, v = t.L_shld, N = t.Do_shld,
                y = t.Do_shld - 2 * t.Sch_sh_cnv, S = t.Pitch_sh_cnv,
                A = k * Math.PI * N * v, F = Math.PI * y ** 2 / 2,
                M = k / 2 * (S - N) * v, T = 3.6,
                I = t => C(t) * T * f(t) / h(t),
                R = t => O(t) * T * p(t) / $(t), H = _ / T / F,
                D = t => H * y / C(t), P = m / T / M, x = t => P * N / O(t),
                B = (t, e = t) => h(t) / y * .023 * D(t) ** .8 * I(t) **
                                  (1 / 3) * (C(t) / C(e)) ** .14,
                Q = t => .092 * t - 34,
                W = t => $(t) / N * .33 * R(t) ** (1 / 3) * x(t) ** .6,
          ...
          for (; st(o) - .001 > 0;) {
            ...
            if (i = c, c = n(tt, i, t.NROptions, "T_in_shield-2", !0),
                o = n(Z, s - 58, t.NROptions, "Tg_out_shield-2", !0), et++,
                et > 35) {
              l.debug(`"Tin_shield",  "t_in_sh_calc": ${r(c)}, "t_in_sh_sup": ${
                  r(i)}`),
          ...
          return e || l.default(`SHLD, cycles: ${et}, T_in_calc: ${
                          t.units.tempC(i)}, Tg_out: ${t.units.tempC(o)}`),
                 t.t_in_sh = i, t.tg_sh = o, {
            m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: i,
                t_out: u, Tb: d(i), Tw: L(d(i), L(d(i))), tg_out: o, tg_in: s,
                Tb_g: d(s, o), LMTD: a(i, u, s, o), DeltaA: s - u,
                DeltaB: o - i, rfi: w, rfo: b, Q_flue: Y(s, o), Q_fluid: X(i),
                Q_R: z(i, s, o, d(i), L(d(i))), Q_rad: q,
                Q_conv: j(i, s, o, d(i), L(d(i))), Cp_fluid: f(i, u),
                Cp_flue: p(s, o), miu_fluid: C(L(d(i))), miu_flue: O(o),
                duty: G(i), "%": G(i) / t.duty, duty_flux: G(i) / A,
                kw_fluid: h(d(i)), kw_tube: g(L(d(i))), kw_flue: $(d(s, o)),
                Prandtl: r(I(d(u))), Reynolds: r(D(d(u))),
                PrandtlFlue: r(R(d(u))), ReynoldsFlue: r(x(d(u))), At: A, Ai: F,
                An: M, Gn: P, hi: B(d(i)), hi_tw: B(d(i), L(d(i))), hr: Q(s),
                ho: E(o), hc: W(d(s, o)), Uo: K(o, s, d(i), L(d(i), L(d(i)))),
                R_int: U(d(i), L(d(i), L(d(i)))), R_tube: J(L(d(i), L(d(i)))),
                R_ext: V(o, s), TUBING: {
                  Material: t.Material,
                  Nt: t.Tpr_sh_cnv,
                  N: k,
      ...
      t.exports = {
        optionsModifier : (t, e, s) => {
          ...
          case "fuel_percent":
            break;
          case "heat_loss":
            a = parseFloat(e[t]), a <= 5 && (s.hLoss = .01 * a);
            break;
          case "rad_dist":
            a = parseFloat(e[t]),
            a >= 40 && a <= 100 && (s.radDist = .01 * a, s.runDistCycle = !1);
            break;
          case "rfi":
            a = parseFloat(e[t]), a >= 0 && (s.rfi = a);
            break;
          case "rfo":
            a = parseFloat(e[t]), a >= 0 && (s.rfoConv = a, s.rfoShld = a);
            break;
          case "rfi_conv":
          ...
          default:
            ((t, e, s) => {
              ...
              case "graph_range":
                ...
                break;
              case "graph_points":
                n = parseFloat(e[t]), n > 0 && n <= 200 && (s.graphPoints = n)
              }
            })(t, e, s),
                ((t, e, s) => {
                ...
                ((t, e, s) => {
                  ...
                  case "p_atm":
                    n = parseFloat(e[t]),
                    n >= .01 && n < 2 && (s.pAtm = n * s.pAtmRef);
                    break;
                  case "air_excess":
                    n = parseFloat(e[t]),
                    n >= 0 && n <= 300 && (s.airExcess = .01 * n);
                    break;
                  case "o2_excess":
                    n = parseFloat(e[t]),
                    n >= 0 && n <= 30 && (s.o2Excess = .01 * n)
                  }
                })(t, e, s)
          }
        }
    ...
    170 : t => {
      const e =
          (...t) => {
            ...
            n = 273.15, l = 101325, a = 5.6145833333, r = 62.371, o = 288.70556,
            u = {
              RtoK : (t = 1) => t * (5 / 9),
              KtoR : (t = 1) => 1.8 * t,
              ...
              BPDtolb_h : (t = 1, e = .84) => t * a * r / 24 * e,
              lb_htoBPD : (t = 1, e = .84) => t / a / r * 24 / e,
      ...
      const c = (t, e = 3) =>
          void 0 !== t
            ...
            m = ({u0 : t, u1 : e, u2 : n, Substance : l}) =>
                0 == t || "-" == t
                    ? (s.debug(
                           `"Viscosity func called for '${l}' without coffs"`),
                       () => 0)
                    : s => t + e * s + n * s ** 2,
            f = {
      ...
      t.exports = {
        ...
        newtonRaphson : (t, e, n, l, a, r) => {
          let o, u, i, c, d, _, m, f;
          "function" != typeof e && (r = a, a = l, l = n, n = e, e = null);
          const p = l || {}, h = void 0 === p.tolerance ? 1e-7 : p.tolerance,
          ...
          for (c = 0; c++ < O;) {
            if (u = t(n),
                e ? i = e(n)
                  : (d = t(n + $), _ = t(n - $), m = t(n + 2 * $),
                     f = t(n - 2 * $), i = (f - m + 8 * (d - _)) * C / 12),
                Math.abs(i) <= g * Math.abs(u))
              return s.error(`Newton-Raphson (${
                         a}): failed to converged due to nearly zero first derivative`),
                     !1;
            if (o = n - u / i, Math.abs(o - n) <= h * Math.abs(o))
              return r || s.debug(`"Newton-Raphson", "func":"${
                              a}", "var converged to":${o}, "iterations":${c}`),
                     o;
            n = o
          }
          return s.error(`Newton-Raphson (${a}): Maximum iterations reached (${
                     O})`),
                 !1
        },
        logger : s,
        ...
        viscosityApprox : ({t1 : t, t2 : e, v1 : n, v2 : l}) => {
          ...
          if (t == e || null == e || null == l)
            return () => n;
          const a = Math.log(n / l) / (1 / t - 1 / e), r = n * Math.exp(-a / t);
          return t => r * Math.exp(a / t)
        },
        initSystem : t => {
          if ("string" != typeof t)
            return i.verbose && s.warn(`invalid type (${
        ...
        normalize : d,
        flueViscosity : (t, e) => {
          const s = d(e, "flueViscosity"), n = m(t[34]), l = m(t[31]),
                a = m(t[6]), r = m(t[3]), o = m(t[2]);
          return t => s.CO2 * a(t) + s.SO2 * n(t) + s.H2O * l(t) + s.O2 * o(t) +
                      s.N2 * r(t)
        },
        flueThermalCond : (t, e) => {
          const s = d(e, "flueThermalCond"), n = _(t[34]), l = _(t[31]),
                a = _(t[6]), r = _(t[3]), o = _(t[2]);
          return t => s.CO2 * a(t) + s.SO2 * n(t) + s.H2O * l(t) + s.O2 * o(t) +
                      s.N2 * r(t)
        },
  ...
  (() => {
   ...
   {browserProcess : p} = s(620), h = (t, e) => {
     const s = (t => {
       const e = l.BPDtolb_h(l.lbtokg(t.mFluid), t.spGrav), s = l.FtoK(t.tIn),
             n = l.FtoK(t.tOut), o = t.miuFluidIn, c = t.miuFluidOut,
             d = l.CpENtoCpSI(t.cpFluidIn), _ = l.CpENtoCpSI(t.cpFluidOut),
             m = l.kwENtokwSI(t.kwFluidIn), f = l.kwENtokwSI(t.kwFluidOut);
       return {
         runDistCycle: t.runDistCycle, p_atm: t.pAtm, t_fuel: t.tFuel,
             ...
             t_in_conv: s, t_out: n, m_fluid: e, Rfi: l.RfENtoRfSI(t.rfi),
             Rfo: l.RfENtoRfSI(t.rfoConv), Rfi_conv: l.RfENtoRfSI(t.rfiConv),
             Rfi_shld: l.RfENtoRfSI(t.rfiShld),
             Rfo_shld: l.RfENtoRfSI(t.rfoShld), efficiency: t.effcy,
             duty_rad_dist: t.radDist, heat_loss_percent: t.hLoss,
             max_duty: l.BTUtokJ(71527.6),
             miu_fluid: u({t1 : s, v1 : o, t2 : n, v2 : c}),
             Cp_fluid: r({x1 : s, y1 : d, x2 : n, y2 : _}),
             kw_fluid: r({x1 : s, y1 : m, x2 : n, y2 : f}),
             Material: "A-312 TP321", h_conv: l.hcENtohcSI(1.5), kw_tube: i,
             Pass_number: 2, Pitch_rad: l.intom(16), N_rad: 42,
             L_rad: l.fttom(62.094), Do_rad: l.intom(8.625),
             Sch_rad: l.intom(.322), Burner_number: 13, Do_Burner: 2.24,
             Width_rad: 17.5, Length_rad: 64.55, Height_rad: 27, N_shld: 16,
             L_shld: l.fttom(60), Do_shld: l.intom(6.625),
             Pitch_sh_cnv: l.intom(12), Sch_sh_cnv: l.intom(.28), Tpr_sh_cnv: 8,
             N_conv: 40, L_conv: l.fttom(60), Do_conv: l.intom(6.625),
             Nf: l.mtoft(60), Tf: l.fttom(.005), Lf: l.fttom(.08),
     ...
     return s.runDistCycle && g(s),
            n.rad_result = d(s), n.shld_result = m(s), n.conv_result = _(s),
            n.rad_result.eff_thermal_val =
                n.rad_result.eff_thermal(n.conv_result.Q_stack),
            n
   }, g = s => {
     let n = 0, l = !0;
     const a = {...s.NROptions};
     a.maxIterations *= 5, a.tolerance *= .1, a.epsilon *= .1, a.h *= .1;
     const r = o((t => {
                   n++, t > .3 && t < 1 && (s.duty_rad_dist = t);
                   const e = {rad : d(s, l), shld : m(s, l), conv : _(s, l)},
                         a = Math.abs(e.rad.Q_fluid) +
                             Math.abs(e.shld.Q_fluid) +
                             Math.abs(e.conv.Q_fluid);
                   return (s.duty - a) / a
                 }),
                 s.duty_rad_dist, a, "rad_dist_final");
     r > .1 &&r < 1
         ? s.duty_rad_dist = r
         : e.error(
    ...
    "undefined" != typeof window ? p(C, c, n, h)
