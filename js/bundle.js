  ...
  var t = {
          ...
          browserProcess: (t, e, s, i) => {
            ...
            if (
              (_ !== {} &&
                (t = ((t, e, s, a) => {
                  const n = {},
                    l = s.filter((e) => e.Formula in t);
                  for (const e in t)
                    if (
                      1 === l.filter((t) => t.Formula == e).length &&
                      "" !== t[e]
                    ) {
      ...
      566: (t, e, s) => {
        const { logger: a, unitConv: n } = s(170),
          { draw: l } = s(597),
          r = document.getElementById("output-sect");
        t.exports = {
          graphicData: (t, e, s) => {
            const o = { ...a };
            (a.error = () => 0),
            ...
            for (let a = 0; a < m; a++) {
              ...
              const l = t(e, s);
              i[a] = {
                m_fluid: 0.001 * n.lb_htoBPD(n.kgtolb(l.rad_result.m_fluid)),
                ...
                m_fuel: l.rad_result.m_fuel ? n.kgtolb(l.rad_result.m_fuel) : 0,
      ...
      597: (t) => {
        const e = document.getElementById("graph-title");
        function s(
          t,
          s,
          a,
          n,
          { svg: l, data: r, margin: o, innerHeight: i, innerWidth: u }
        ) {
          const c = (u -= o.left) < 1200 ? "1.7em" : "2.5em",
            d = u < 500 ? "0.9em" : "1.5em",
            _ = u < 900 ? 0.055 * i : 0.06 * i,
            m = u < 900 ? "1em" : "1.2em",
            f = u < 900 ? 0.04 * u : 0.03 * u,
            p = (e) => e[t.graphVar];
          let h,
            g = "";
          switch (t.graphVar) {
          ...
          switch (s) {
            case "co2_emiss":
              (C = "es" == t.lang ? "Emisiones de CO2" : "CO2 Emissions"),
                (b = "es" == t.lang ? `${C} [t/año]` : `${C} [t/year]`);
              break;
            case "m_fuel":
              (C = "es" == t.lang ? "Flujo de combustible" : "Fuel mass flow"),
                (b = `${C} [lb/h]`);
              break;
            case "efficiency":
              (C =
                "es" == t.lang ? "Eficiencia (@ NHV)" : "Efficiency (@ NHV)"),
                (b = `${C} [%]`);
              break;
            case "cnv_tg_out":
              (C =
          ...
          const O = `${C}`,
            w = d3.extent(r, p),
            v = d3.scaleLinear().range([0, u]).domain(w).nice(),
            k = d3.extent(r, $),
            N = d3.scaleLinear().range([i, 0]).domain(k).nice(),
            y = d3.axisBottom(v).tickSize(-i).tickPadding(15),
            S = d3.axisLeft(N).tickSize(-u).tickPadding(10),
            F = l
              .append("g")
              .attr(
                "transform",
                `translate(${a + 1.25 * o.left},${n + o.top / 2})`
              ),
            A = F.append("g").call(y).attr("transform", `translate(0,${i})`);
          ...
          const I = d3
            ...
            T = R.node().getTotalLength();
          R.attr("stroke-dashoffset", T)
            .attr("stroke-dasharray", T)
            .transition()
            .duration(1e3)
            .ease(d3.easeSin)
            .attr("stroke-width", 2)
        ...
        t.exports = {
          draw: function (t = [], e = {}) {
            const a = window.innerHeight,
              n = 0.97 * window.innerWidth;
            let l = n > 1300 ? 2 : 1;
            const r = { top: 150, right: 30, bottom: 100, left: 45 },
              o = (a - r.top - r.bottom) / (1 == l ? 2 : 3),
              i = (n - 1.5 * r.left - r.right) / l,
              u = {
                svg: d3
                  .select("svg")
                  .attr("width", n)
            ...
            s(e, "m_fuel", 0, 0 * a, u),
              s(e, "cnv_tg_out", 1 == l ? 0 : n / 2, 1 == l ? 0.5 * a : 0, u),
              s(e, "rad_dist", 0, 1 == l ? 1 * a : a / 2, u),
              s(e, "cnv_dist", 1 == l ? 0 : n / 2, 1 == l ? 1.5 * a : a / 2, u),
              s(e, "efficiency", 0, 1 == l ? 2 * a : a, u),
              s(e, "co2_emiss", 1 == l ? 0 : n / 2, 1 == l ? 2.5 * a : a, u);
          },
        };
      },
      144: (t, e, s) => {
        ...
        t.exports = {
          stringRadResult: (t, e, s) => {
            ...
            return (
              ...
              (r += `\n\n  t_in:     ${l.tempC(e.t_in)}\n  t_out:    ${l.tempC(
                ...
                e.TUBING.N
              }\n    Wall Thickness: ${l.lengthC(
                e.TUBING.Sch
              )}\n    Outside Di:     ${l.lengthC(
                e.TUBING.Do
              )}\n    Pitch:          ${l.lengthC(
                e.TUBING.S_tube
          ...
          stringShldResult: (t, e, s) => {
            ...
            return (
              ...
              (r += `\n\n  t_in:     ${l.tempC(e.t_in)}\n  t_out:    ${l.tempC(
                ...
                e.TUBING.Do
              )}\n    Tran Pitch:     ${l.lengthC(
                e.TUBING.S_tube
              )}\n    Long Pitch:     ${l.lengthC(
                e.TUBING.S_tube
              )}\n    Ef. Length:     ${l.length(e.TUBING.L)}\n\n  `),
              "\n" + r
            );
              ...
              (r =
                "es" == t
                  ? `\nDatos de entrada\n  (en caso de no haber sido introducidos, el\n  simulador selecciona los valores predeterminados)\n\n  Sistema de unidades:         ${
                    ...
                    } aire seco\n\n\n  Temperatura de entrada (residuo): ${l.tempC(
                      e.conv_result.t_in_given,
                      0
                    )}\n  Temperatura de salida (residuo):  ${l.tempC(
                      e.rad_result.t_out,
                      0
                      ...
                      e.debug_data.spGrav
                    }\n  Flujo másico (residuo):        ${l.mass_flow(
                      e.rad_result.m_fluid,
                      1
                    )}\n\n  Calor absorbido ("duty") requerido: ${l.heat_flow(
                      e.rad_result.duty_total
                    )}\n  Calor absorbido ("duty") calculado: ${l.heat_flow(
                      e.rad_result.duty +
                        e.shld_result.duty +
                        e.conv_result.duty
                      ...
                      e.flows.GCV
                    }\n\n  Flujo másico (combustible): ${l.mass_flow(
                      e.rad_result.m_fuel,
                      1
                    )}\n  Flujo másico (gases):       ${l.mass_flow(
                      e.rad_result.m_flue,
                      1
                    )}\n  Flujo másico (aire):        ${l.mass_flow(
                      e.rad_result.m_air,
                      1
                    )}\n\n  Peso molecular (combustible): ${l["mass/mol"](
                      e.flows.fuel_MW
                  ...
                  : `\nInput Data\n  (Default values will be taken in case\n    of no entries)\n\n  Unit System:           ${
                      ...
                      e.debug_data.moisture
                    } dry Air\n\n\n  Process fluid Inlet Temperature:  ${l.tempC(
                      e.conv_result.t_in_given,
                      0
                    )}\n  Process fluid Outlet Temperature: ${l.tempC(
                      e.rad_result.t_out,
                      0
                      ...
                      e.debug_data.spGrav
                    }\n  Process fluid Mass Flow: ${l.mass_flow(
                      e.rad_result.m_fluid,
                      1
                    )}\n\n  Required Duty:   ${l.heat_flow(
                      e.rad_result.duty_total
                    )}\n  Calculated Duty: ${l.heat_flow(
                      e.rad_result.duty +
                        e.shld_result.duty +
                        e.conv_result.duty
                      ...
                      e.flows.AC_mass_theor_moistAir,
                      3
                    )}\n\n  Fuel Mass Flow:           ${l.mass_flow(
                      e.rad_result.m_fuel,
                      1
                    )}\n  Flue Gas Mass Flow:       ${l.mass_flow(
                      e.shld_result.m_flue,
                      1
                    )}\n  Combustion Air Mass Flow: ${l.mass_flow(
                      e.rad_result.m_air,
                      1
                    )}\n\n  Fuel MW:             ${l["mass/mol"](
                      e.flows.fuel_MW
          ...
          stringCompactResult: (t, e, s, l = {}, r = {}) => {
            ...
            return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
              ...
              o
                ? i.heat_flow(l.rad_result.duty, 3, !0) +
              ...
              o
                ? i.heat_flow(l.shld_result.duty, 3, !0) +
              ...
              o
                ? i.heat_flow(l.conv_result.duty, 3, !0) +
              ...
              o
                ? a(
                    ((44.01 * l.products.CO2) / l.flows.fuel_MW) *
                      l.rad_result.m_fuel *
                      8.76,
                    0
                  )
              ...
              o
                ? i.heat_flow(l.conv_result.Q_stack, 3, !0) +
                  ` - (${a(
                    (100 * l.conv_result.Q_stack) / l.rad_result.Q_in,
                    2
                  )})`
                : ""
              ...
              o
                ? i.heat_flow(l.rad_result.Q_losses, 3, !0) +
                  ` - (${a(
                    (100 * l.rad_result.Q_losses) / l.rad_result.Q_in,
                    2
                  )})`
                : ""
      ...
      911: (t, e, s) => {
        ...
        t.exports = {
          combSection: (t, e, s, p) => {
            ...
            return (
              p ||
                ((s.m_flue_ratio = (M * R.flue_MW) / g(N)),
                ...
                (s.adFlame = a(
                  ((t, e, s, a) => {
                    ...
                    let m = 0;
                    for (const e in t)
                      (d[m] = t[e] * C(l.filter((t) => t.Formula == e)[0])(s)),
                        m++;
                    return (t) =>
                      ((t) =>
                        e.O2 * r(t) +
                ...
                l.info(
                  `Adiabatic flame temp: [${r(s.adFlame)} K] ${b.tempC(
                    s.adFlame
                  )}`
                ),
                o(y),
          ...
          convSection: (t, e) => {
            ...
            const c = (t, e = o) => 0.5 * (t + e),
              ...
              j = (t = c(o, i), e = t, s = i) =>
                (((t) => K(t))(s) / x) *
                  (v / k) *
                  (O + 1 / J(t, e) + (k * Math.log(v / k)) / (2 * h(e))) +
                t,
              q = (t, e) => 2.2 * 2.7431452152 * B ** 0.5 * (R / T) ** 0.75;
            let z = (t, e) => (g(t) / v) * 0.33 * W(t) ** (1 / 3) * U(t) ** 0.6;
            const X = (t, e) => 1 / (1 / (z(t, e) + q()) + b),
              Y = 1.36 * h(j(c(i, o), j(c(i, o)))),
              Z = A + M / 2,
              tt = (X(c(s, a), j(c(i, o), j(c(i, o)))) / (6 * Y * M)) ** 0.5,
              et = Math.tanh(tt * Z) / (tt * Z),
              st = et * (0.7 + 0.3 * et),
              at = v + 2 * A,
              nt = st * (0.45 * Math.log(at / v) * (st - 1) + 1),
              lt = (t, e) => (X(t, e) * (nt * H + R)) / T,
              rt = (e, s) =>
                ((t, e, s, a) => {
                  const n = e.Lf,
                    l = 1 / e.Nf - e.Tf,
                    r = 0.35 + 0.65 * Math.exp((-0.25 * n) / l),
                    o = e.Pitch_sh_cnv,
                    i = e.Pitch_sh_cnv,
      ...
      623: (t, e, s) => {
        const { newtonRaphson: a, logger: n, round: l, unitConv: r } = s(170),
          o = (t) => {
            const e = {
        ...
        t.exports = {
          radSection: (t, e) => {
            ...
            const f = t.t_air,
              ...
              { Aw: D, Aw_aAcp: P } = i(I, T, 1, H, x),
              B = (Math.PI * N ** 2) / 2,
              E = 2.04133464e-7,
              Q = (t) =>
                ((t, e, s, a, n, l) => {
                  const { Aw_aAcp: r } = i(e, s, a, n, l),
                    u = o(t),
                    c = {
              ...
              rt = (t, e = t, s = m) =>
                (s / R) *
                  (k / N) *
                  (C + 1 / lt(t, e) + (N * Math.log(k / N)) / (2 * tt(e))) +
                t,
              ot = (t) => K(t) * z * (f - h),
              it = (t) => t * q * (p - h),
              ut = (t) => t * V,
        ...
        t.exports = {
          shieldSection: (t, e) => {
            ...
            const d = (t, e = i) => 0.5 * (t + e),
              ...
              J = (t, e = s) => 1 / W(t, e),
              K = (t, e, s, a) =>
                1 / ((t, e, s, a) => J(t, e) + U(a) + V(s, a))(t, e, s, a),
              j = t.q_rad_sh,
          ...
          optionsModifier: (t, e, s) => {
            ...
            switch (t) {
              ...
              case "fuel_percent":
                break;
              case "heat_loss":
                (l = parseFloat(e[t])), l <= 5 && (s.hLoss = 0.01 * l);
                break;
              case "rad_dist":
                (l = parseFloat(e[t])),
                  l >= 40 &&
                    l <= 100 &&
                    ((s.radDist = 0.01 * l), (s.runDistCycle = !1));
                break;
              case "rfi":
      ...
      170: (t) => {
        const e = (...t) => {
          ...
          i = {
            ...
            BPDtolb_h: (t = 1, e = 0.84) => ((t * l * r) / 24) * e,
            lb_htoBPD: (t = 1, e = 0.84) => ((t / l / r) * 24) / e,
        ...
        const c = (t, e = 3) =>
          ...
          d = (t, e, a) => {
            ...
            for (const t in n) n[t] = n[t] / l;
            return (
              a || s.debug(`"normalize", "name": "${e}", "total": ${l}`), n
            );
          },
          ...
          newtonRaphson: (t, e, a, n, l, r) => {
            ...
            for (c = 0; c++ < b; ) {
              if (
                ...
                return (
                  s.error(
                    `Newton-Raphson (${l}): failed to converged due to nearly zero first derivative`
                  ),
                  !1
                );
              if (((o = a - i / u), Math.abs(o - a) <= h * Math.abs(o)))
                return (
                  r ||
                    s.debug(
                      `"Newton-Raphson", "func":"${l}", "var converged to":${o}, "iterations":${c}`
                    ),
                  o
                );
              a = o;
            ...
            return (
              s.error(
                `Newton-Raphson (${l}): Maximum iterations reached (${b})`
              ),
              !1
            );
          },
