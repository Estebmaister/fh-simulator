        ...
        597 : t => {
          ...
          s(t, s, a, n,
            ...
            const c = (u -= o.left) < 700 ? "1.5em" : "2.5em",
                  d = u < 900 ? "0.9em" : "1.5em",
                  _ = u < 900 ? .055 * i : .06 * i,
                  m = u < 900 ? "1em" : "1.2em", f = u < 1300 ? "2em" : .03 * u,
                  p = e => e[t.graphVar];
            let h, g = "";
            switch (t.graphVar) {
            case "humidity":
            ...
            case "m_fuel":
              ...
              break;
            case "efficiency":
              C = "es" == t.lang ? "Eficiencia (@ NHV)" : "Efficiency (@ NHV)",
              b = `${C} [%]`;
              break;
            case "cnv_tg_out":
              C = "es" == t.lang ? "Temperatura de Chimenea"
                                 : "Stack Temperature",
              b = `${C} [F]`;
              break;
            case "rad_dist":
              C = "es" == t.lang ? "Distribución Radiante"
                                 : "Radiant distribution",
              b = `${C} [%]`;
              break;
            case "cnv_dist":
              C = "es" == t.lang ? "Distribución Convectiva"
                                 : "Convective distribution",
              b = `${C} [%]`
            }
            const O = `${C}`, w = d3.extent(r, p),
          ...
          t.exports = {
            draw : function(t = [], e = {}) {
              const a = .85 * window.innerHeight, n = .95 * window.innerWidth;
              let l = n > 1300 ? 2 : 1;
              const r = {top : 150, right : 0, bottom : 100, left : 45},
                    o = (a - r.top - r.bottom) / (1 == l ? 2 : 3),
                    i = (n - 1.5 * r.left - r.right) / l, u = {
                      svg : d3.select("svg")
                                .attr("width", n)
                                .attr("height", 6 * a / (2 * l))
              ...
              s(e, "m_fuel", 0, 0 * a, u),
                  s(e, "cnv_tg_out", 1 == l ? 0 : n / 2, 1 == l ? .5 * a : 0,
                    u),
                  s(e, "rad_dist", 0, 1 == l ? 1 * a : a / 2, u),
                  s(e, "cnv_dist", 1 == l ? 0 : n / 2, 1 == l ? 1.5 * a : a / 2,
                    u),
            ...
            convSection : (t, e) => {
              ...
              const c = (t, e = o) => .5 * (t + e), d = t.m_fluid, _ = t.m_flue,
                    ...
                    j = (t = c(o, i), e = t, s = i) =>
                        ...
                        t,
                    q = (t, e) => 2.2 * 2.7431452152 * B ** .5 * (R / T) ** .75;
              ...
              return i = u,
                ...
                t_fin: t.Ts(c(i), j(c(i), j(c(i)))),
                    ...
                    Ai: D, An: I, Ao: T, Apo: R, Afo: H, Ef: nt, Gn: V / E,
          ...
          t.exports = {
            radSection : (t, e) => {
              ...
              const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                    ...
                    R = b * Math.PI * k * w, T = b * y * w, H = O / 2 * S * v,
                    x = (t => {
                      const e =
          ...
          t.exports = {
            shieldSection : (t, e) => {
              ...
              const d = (t, e = i) => .5 * (t + e), _ = t.m_fluid, m = t.m_flue,
                    ...
                    M = v / 2 * (S - N) * k, I = 3.6,
                    R = t => C(t) * I * f(t) / h(t),
                    T = t => b(t) * I * p(t) / $(t), H = _ / I / A,
                    x = t => H * y / C(t), D = m / I / M, P = t => D * N / b(t),
                    B = (t, e = t) => h(t) / y * .023 * x(t) ** .8 * R(t) **
                                      (1 / 3) * (C(t) / C(e)) ** .14,
                    E = t => .092 * t - 34,
                    Q = t => $(t) / N * .33 * T(t) ** (1 / 3) * P(t) ** .6,
              ...
              return e || n.default(`SHLD, cycles: ${et}, T_in_calc: ${
                ...
                m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: u,
                    ...
                    PrandtlFlue: r(T(d(i))), ReynoldsFlue: r(P(d(i))), At: F,
