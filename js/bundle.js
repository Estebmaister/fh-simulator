  ...
  var t = {
      ...
      597: (t, e, s) => {
        ...
        function r(
          ...
          const d = (c -= i.left) < 700 ? "1.5em" : "2.5em",
            _ = c < 900 ? "0.9em" : "1.5em",
            m = c < 900 ? 0.055 * u : 0.06 * u,
            f = c < 900 ? "1em" : "1.2em",
            p = c < 1300 ? "2em" : 0.03 * c,
            h = (e) => e[t.graphVar];
          let g,
          ...
          const w = `${b}`,
            ...
            N = d3.extent(o, C),
            y = d3.scaleLinear().range([u, 0]).domain(N).nice(),
            S = d3.axisBottom(k).tickSize(-u).tickPadding(15),
            F = d3.axisLeft(y).tickSize(-c).tickPadding(10),
            A = r
              .append("g")
              .attr(
                "transform",
            ...
            M = A.append("g").call(S).attr("transform", `translate(0,${u})`);
          M.select(".domain").remove(),
            M.selectAll(".tick")
              .selectAll("line")
            ...
            M.append("text")
              ...
              .attr("font-size", d)
              .text($);
          const T = A.append("g").call(F).attr("fill", "#FEF8F3");
        ...
        t.exports = {
          draw: function (t = [], e = {}) {
            ...
            r(e, "m_fuel", 0, 0 * s, u),
              r(e, "cnv_tg_out", 1 == n ? 0 : a / 2, 1 == n ? 0.5 * s : 0, u),
              r(e, "rad_dist", 0, 1 == n ? 1 * s : s / 2, u),
              r(e, "cnv_dist", 1 == n ? 0 : a / 2, 1 == n ? 1.5 * s : s / 2, u),
          ...
          combSection: (t, e, s, p) => {
            ...
            return (
              p ||
                ...
                (I.Cp_fuel = b.cp(I.Cp_fuel_val)),
                (I.Cp_flue = b.cp(I.Cp_flue(s.t_air))),
                (I.flue_MW = b["mass/mol"](I.flue_MW)),
                (s.NCV = -O(N, y, k, s.t_amb) / g(N)),
                (s.GCV = -O(N, y, k, s.t_amb, !0) / g(N)),
                (I.NCV = b["energy/mass"](s.NCV, 0)),
                (I.GCV = b["energy/mass"](s.GCV, 0)),
                (I.NCV_val = s.NCV),
                (I.GCV_val = s.GCV),
                (s.adFlame = a(
                  ((t, e, s, a) => {
          ...
          convSection: (t, e) => {
            ...
            const c = (t, e = o) => 0.5 * (t + e),
              ...
              j = (t = c(o, i), e = t, s = i) =>
                ...
                t,
              q = (t, e) => 2.2 * 2.7431452152 * B ** 0.5 * (I / R) ** 0.75;
