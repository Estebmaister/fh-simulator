    ...
    566 : (t, e, s) => {
      ...
      t.exports = {
        graphicData : (t, e, s) => {
          ...
          const r = [];
          let o, u, i = JSON.parse(localStorage.getItem(`${s.title}`));
          ...
          case "humidity":
            ...
            break;
          case "air_excess":
            u = "airExcess", s.graphRange = .01 * s.graphRange;
            break;
          case "o2_excess":
            u = "o2Excess", s.graphRange = .01 * s.graphRange;
            break;
          case "m_fluid":
          ...
          i || (i = {}), i[`${window.location.search}`] = r,
