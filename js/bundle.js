(() => {
      ...
      t = {
        620 : (t, e, s) => {
          ...
          t.exports = {
            browserProcess : (t, e, s, i) => {
              ...
              _.length > 0 && _.forEach((t => {"es" != t && "es_graph" != t ||
                                               (c = "es")})),
                  s.lang = c;
              const d = (t => {
                if ("" == t)
        ...
        851 : (t, e, s) => {
          const {stringCompactResult :
                     n} = s(144),
                     {logger : l} = s(170), a = "base", r = "modified",
                     o = (t, e) => !t || !t.time ||
          ...
          t.exports = {
            compactResult : (t, e, s, l) => {
              ...
              localStorage.setItem(
                  ...
                  s.title === a
                      ? (d = s, c = i, f = JSON.parse(localStorage.getItem(r)),
                         o(f, r), m = f ? f.opt : {}, _ = f ? f.result : {})
                      : (m = s, _ = i, f = JSON.parse(localStorage.getItem(a)),
                         o(f, a), f || (f = {result : t(e, l), opt : l}),
                         d = f ? f.opt : {}, c = f ? f.result : {});
        ...
        566 : (t, e, s) => {
          ...
          t.exports = {
            graphicData : (t, e, s) => {
              ...
              if (u && (o = u[`${window.location.search}`],
              ...
              const c = s.graphPoints, _ = s.graphRange;
              let d = s[i] - _ / 2;
              d < 0 && (d = 0), a.info(`Var: ${i}, centerValue: ${
                                    s[i]}, range: ${_}, points: ${c}`);
              for (let n = 0; n < c; n++) {
                s[i] = d + n * _ / c;
                const a = t(e, s);
                r[n] = {
                  ...
                  m_fuel : a.rad_result.m_fuel ? l.kgtolb(a.rad_result.m_fuel)
                                               : 0,
                  ...
                  cnv_dist : a.conv_result["%"] < 1
                                 ...
                                 : 0,
                  co2_emiss : Math.round(100 * a.products.CO2 *
                ...
                stringCombResult : (t, e, s) => {
                  ...
                  return r = "es" == t
                                 ? `\nDatos de entrada\n  (en caso de no haber sido introducidos, el\n  simulador selecciona los valores predeterminados)\n\n  Sistema de unidades:         ${
                                       ...
                                       n(e.rad_result.eff_gcv_val,
                                         2)}%\n\n  Emisiones de CO2: ${
                                       n(44.01 * e.products.CO2 /
                                             e.flows.fuel_MW *
                    ...
                    (t, e, s, a = {}, r = {}) => {
                      ...
                      return `<table class="tg">\n<thead>\n  <tr>\n    <th>(${
                          ...
                          n(100 * e.conv_result.Q_stack / e.rad_result.Q_in,
                            2)})</td>\n    <td class="tg-simple">${
                          o ? i.heat_flow(a.conv_result.Q_stack, 3, !0) +
                                  ` - (${
                                      n(100 * a.conv_result.Q_stack /
                                            a.rad_result.Q_in,
                                        2)})`
                          ...
                          n(100 * e.rad_result.Q_losses / e.rad_result.Q_in,
                            2)})</td>\n    <td class="tg-simple">${
                          o ? i.heat_flow(a.rad_result.Q_losses, 3, !0) +
                                  ` - (${
                                      n(100 * a.rad_result.Q_losses /
                                            a.rad_result.Q_in,
                                        2)})`
        ...
        911 : (t, e, s) => {
         ...
         p = ({c0 : t, c1 : e, c2 : s, c3 : n, MW : l, Substance : o}, i,
              u) => c =>
              (c < 250 && !u &&
         ...
         h =
              (t, e, s) => {
                ...
                const l = d.filter((t => t.Formula in n)), a = [];
                let r = 0;
                for (const t in n)
                  a[r] = s =>
              ...
              "-" === t.Cp0
                  ? "-" === t.h0
                    ...
                    : void 0 === e ? () => t.h0
                                   : t.h0
              : void 0 === e
                  ? e => t.h0 + (e - l.tempAmbRef) *
                                    p(t, !0, !0)((l.tempAmbRef + e) / 2)
                  : t.h0 + (e - l.tempAmbRef) *
                               p(t, !0, !0)((l.tempAmbRef + e) / 2),
         O = (t, e, s, n = !1) => {
           const a = C(d[6]), r = C(d[34]), o = C(d[2]);
           let i = C(d[31]);
           return !0 === n && (i = C(d[32])), void 0 === s && (s = l.tAmb),
                  void 0 === e ? e => t.CO2 * a(e) + t.SO2 * r(e) +
                                      t.H2O * i(e) - C(t)(s) - t.O2 * o(s)
                               : t.CO2 * a(e) + t.SO2 * r(e) + t.H2O * i(e) -
                                     C(t)(s) - t.O2 * o(s)
         }, b = (t, e, s, n, l = !1) => {
           let a = 0;
           for (const r in t) {
          ...
          t.exports = {
            combSection : (t, e, s, p) => {
              ...
              f(e, v) || (N = u(e, "combSection")), ((t, e, s = {}) => {
                ...
                0 === n ||
                    (a.error(`[some fuels aren't in the database, #badFuels: ${
                         n}],`),
                     s.err +=
              ...
              if (y.O2 <= 0 || y.N2 < 0)
                ...
                S.H2O = t / s.p_atm, v.dryAirPressure = O.pressure(e),
              ...
              return p || (s.m_flue_ratio = M * T.flue_MW / g(N),
                           ...
                           T.NCV_val = s.NCV, T.GCV_val = s.GCV,
                           s.adFlame = n(
                               ((t, e, s, n) => {
                                 void 0 === s && (s = l.tAmb),
                                     void 0 === n && (n = 0);
              ...
              {
                flows: T, products: y, debug_data: v
              }
            }
          }
        },
        399 : (t, e, s) => {
          ...
          t.exports = {
            convSection : (t, e) => {
              let s = t.tg_sh, n = 0, o = t.t_in_sh, i = t.t_in_conv, u = 0;
              const c = (t, e = o) => .5 * (t + e), _ = t.m_fluid, d = t.m_flue,
                    ...
                    q = (t = c(o, i), e = t, s = i) =>
                        ...
                        t,
                    j = (t, e) => 2.2 * 2.7431452152 * B ** .5 * (T / R) ** .75;
              let z = (t, e) => g(t) / v * .33 * E(t) ** (1 / 3) * V(t) ** .6;
              const X = (t, e) => 1 / (1 / (z(t, e) + j()) + O),
                    Y = 1.36 * h(q(c(i, o), q(c(i, o)))), Z = A + M / 2,
                    tt = (X(c(s, n), q(c(i, o), q(c(i, o)))) / (6 * Y * M)) **
                         .5,
                    et = Math.tanh(tt * Z) / (tt * Z), st = et * (.7 + .3 * et),
                    nt = v + 2 * A,
                    lt = st * (.45 * Math.log(nt / v) * (st - 1) + 1),
                      ...
                      const l = e.Lf, a = 1 / e.Nf - e.Tf,
                            ...
                            d = (t, e) =>
                                t + (e - t) / ((Math.exp(1.4142 * s * n) +
                                                Math.exp(-1.4142 * s * n)) /
                                               2);
                      return e.Ts = d, (e, s) => (e => .25 * t(e) ** -.35)(e) *
                                                 r * c * _ ** .5 *
                                                 (e / d(e, s)) ** .25
                    })(V, t, tt, Z)(e, s);
              ...
              const ot = t => a(t, o, s, n),
                    ...
                    dt = (t, e) => d * f(t, e) * (t - e),
                    mt = (t, e, s) =>
                        _t(c(s, e), c(t), q(c(t), q(c(t)))) * D * ot(t),
                    ft = (t, e = .7 * s) => s - K(t) / (d * f(c(s, e))),
                    pt = () => 100 * (mt(u, s, n) - K(u)) / K(u);
              for (n = ft(i), u = i; n - u < 0;)
                u *= 1.002, n = ft(u);
              let ht, gt;
              ...
              return i = u,
                     e ||
                         l.default(`CONV, T_in_calc: ${
                             t.units.tempC(u)}, T_in_given: ${
                             t.units.tempC(
                                 t.t_in_conv)}, Tg_stack: ${t.units.tempC(n)}`),
                     t.t_in_conv_calc = i, t.tg_conv = n, {
                t_fin: t.Ts(c(i), q(c(i), q(c(i)))),
                    t_fin_max: o +
                        mt(i, s, n) / (D / (t.N_conv / t.Tpr_sh_cnv)) *
                            (v / k) *
                            (b + 1 / J(c(i), q(c(i), q(c(i)))) +
                             k * Math.log(v / k) / (2 * h(q(c(i), q(c(i)))))),
                    t_in_given: t.t_in_conv, t_in: i, t_out: o, Tb: c(i),
                    Tw: q(c(i), q(c(i))), tg_out: n, tg_in: s, Tb_g: c(s, n),
                    rfi: b, rfo: O, LMTD: ot(i), DeltaA: s - o, DeltaB: n - i,
                    Q_flue: dt(s, n), Q_fluid: K(i), Q_conv: mt(i, s, n),
                    Q_stack: dt(n, t.t_air), duty: K(i), "%": K(i) / t.duty,
                    duty_flux: K(i) / D, Cp_fluid: m(i, o), Cp_flue: f(s, n),
                    miu_fluid: $(q(c(i))), miu_flue: C(n), kw_fluid: p(c(i)),
                    kw_tube: h(q(c(i))), kw_fin: Y, kw_flue: g(c(s, n)),
                    Prandtl: r(W(c(o))), Reynolds: r(L(c(o))),
                    PrandtlFlue: r(E(c(o))), ReynoldsFlue: r(V(c(o))), At: D,
                    Ai: P, An: I, Ao: R, Apo: T, Afo: H, Ef: lt, Gn: U / Q,
                    ...
                    Uo: _t(c(s, n), c(i), q(c(i))), R_int: it(c(i), q(c(i))),
                    R_tube: ut(q(c(i))), R_ext: ct(c(s, n), q(c(i))), TUBING: {
                      Material: t.Material,
                      Nt: S,
                      N: y,
                      Sch: t.Sch_sh_cnv,
          ...
          t.exports = {
            radSection : (t, e) => {
              ...
              const f = t.t_air, p = t.t_fuel, h = t.t_amb, g = t.t_in_conv,
                    ...
                    W = t => ((t, e, s, n, l, a) => {
                      const {Aw_aAcp : r} = i(e, s, n, l, a), u = o(t), c = {
                    ...
                    })(M, I, R, 1, H, D)(r.KtoF(t)),
                    E = t.duty_rad_dist || .7, G = t.efficiency || .8,
                    L = t.heat_loss_percent || .015, U = t.NCV, V = t.GCV,
                    J = t.m_fluid, K = (e = _) => t.m_air_ratio * e,
                    q = (e = _) => t.m_flue_ratio * e, j = t.Cp_fuel($(p, h)),
                    z = t.Cp_air($(f, h)),
                    ...
                    lt = t => st * N / et(t),
                    at = (t, e = t) => Z(t) / N * .023 * lt(t) ** .8 * nt(t) **
                                       (1 / 3) * (et(t) / et(e)) ** .14,
                    rt = (t, e = t, s = m) =>
                        s / T * (k / N) *
                            (C + 1 / at(t, e) +
                        ...
                        t,
                    ot = t => K(t) * z * (f - h), it = t => t * j * (p - h),
                    ut = t => t * U, ct = t => ut(t) + ot(t) + it(t),
                    _t = (t, e) => q(e) * Y(t, h) * (t - h),
                    dt = t => ut(t) * L, mt = (t, e) => F * T * (t - e),
                    ...
                    $t = (t, e) => J * X(e, t) * (t - e);
              if (0 !== c) {
                d = $t(c, g), m = d * E, u = g + d * (1 - E) / (J * X(g, c));
                const a = n((t => $t(c, u) - ht(t, rt($(c), rt($(c))))), 1e3,
                ...
                e || l.debug(`"mass_fuel_seed", "value": "${o}"`),
                    ...
                    o && (_ = o), m = ht(s, rt($(c), rt($(c))))
              } else {
                d = ut(_) * G, m = d * E, u = g + d * (1 - E) / (J * X(g));
                let a = g + d / (J * X(u));
                const r = n((t => ct(_) - gt(t, _, rt($(a), rt($(a))))), 1e3,
                            t.NROptions, "Tg_mFuel-seed_radiant", e);
                r && (s = r),
                    a = n((t => $t(t, u) - ht(s, rt($(t), rt($(t))))), a,
          ...
          t.exports = {
            shieldSection : (t, e) => {
              ...
              const _ = (t, e = i) => .5 * (t + e), d = t.m_fluid, m = t.m_flue,
                    ...
                    O = e => t.miu_flue(e), b = t.Rfo_shld, w = t.Rfi_shld,
                    v = t.N_shld, k = t.L_shld, N = t.Do_shld,
                    y = t.Do_shld - 2 * t.Sch_sh_cnv, S = t.Pitch_sh_cnv,
                    F = v * Math.PI * N * k, A = Math.PI * y ** 2 / 2,
                    M = v / 2 * (S - N) * k, I = 3.6,
                    T = t => C(t) * I * f(t) / h(t),
                    R = t => O(t) * I * p(t) / $(t), H = d / I / A,
                    D = t => H * y / C(t), P = m / I / M, x = t => P * N / O(t),
                    B = (t, e = t) => h(t) / y * .023 * D(t) ** .8 * T(t) **
                                      (1 / 3) * (C(t) / C(e)) ** .14,
                    Q = t => .092 * t - 34,
                    ...
                    K = (t, e, s, n) =>
                        1 /
                        ((t, e, s, n) => J(t, e) + V(n) + U(s, n))(t, e, s, n),
                    q = t.q_rad_sh,
              ...
              for (; st(o) - .001 > 0;) {
                ...
                if (u = c, c = n(tt, u, t.NROptions, "T_in_shield-2", !0),
                    o = n(Z, s - 58, t.NROptions, "Tg_out_shield-2", !0), et++,
                    et > 35) {
                  l.debug(`"Tin_shield",  "t_in_sh_calc": ${
                      r(c)}, "t_in_sh_sup": ${r(u)}`),
              ...
              return e || l.default(`SHLD, cycles: ${et}, T_in_calc: ${
                ...
                m_flue: m, t_in_sup: .5 * (t.t_in_rad + t.t_in_conv), t_in: u,
                    t_out: i, Tb: _(u), Tw: L(_(u), L(_(u))), tg_out: o,
                    tg_in: s, Tb_g: _(s, o), LMTD: a(u, i, s, o), DeltaA: s - i,
                    DeltaB: o - u, rfi: w, rfo: b, Q_flue: Y(s, o),
                    Q_fluid: X(u), Q_R: z(u, s, o, _(u), L(_(u))), Q_rad: q,
                    Q_conv: j(u, s, o, _(u), L(_(u))), Cp_fluid: f(u, i),
                    Cp_flue: p(s, o), miu_fluid: C(L(_(u))), miu_flue: O(o),
                    duty: G(u), "%": G(u) / t.duty, duty_flux: G(u) / F,
                    kw_fluid: h(_(u)), kw_tube: g(L(_(u))), kw_flue: $(_(s, o)),
                    Prandtl: r(T(_(i))), Reynolds: r(D(_(i))),
                    PrandtlFlue: r(R(_(i))), ReynoldsFlue: r(x(_(i))), At: F,
                    Ai: A, An: M, Gn: P, hi: B(_(u)), hi_tw: B(_(u), L(_(u))),
                    hr: Q(s), ho: E(o), hc: W(_(s, o)),
                    Uo: K(o, s, _(u), L(_(u), L(_(u)))),
                    R_int: U(_(u), L(_(u), L(_(u)))),
                    R_tube: V(L(_(u), L(_(u)))), R_ext: J(o, s), TUBING: {
                      Material: t.Material,
                      Nt: t.Tpr_sh_cnv,
                      N: v,
                      Sch: t.Sch_sh_cnv,
          ...
          t.exports = {
            optionsModifier : (t, e, s) => {
              ...
              case "rad_dist":
                a = parseFloat(e[t]),
                a >= 40 && a <= 100 &&
                    (s.radDist = .01 * a, s.runDistCycle = !1);
                break;
              case "rfi":
        ...
        170 : t => {
          const e =
              (...t) => {
                ...
                n = 273.15, l = 101325, a = 5.6145833333, r = 62.371,
                o = 288.70556, i = {
                  RtoK : (t = 1) => t * (5 / 9),
                  KtoR : (t = 1) => 1.8 * t,
              ...
              void 0 !== t
                ...
                _ =
                    (t, e, n) => {
                      ...
                      for (const t in l)
                        l[t] = l[t] / a;
                      return n || s.debug(`"normalize", "name": "${
                                      e}", "total": ${a}`),
                             l
                    },
                ...
                p = {
                  ...
                  pressure : (t, e, s, n) => f(n, s, e, "psi", .0001450377 * t),
                  mass : (t, e, s, n) => f(n, s, e, "lb", i.kgtolb(t)),
                  mass_flow : (t, e, s, n) => f(n, s, e, "lb/h", i.kgtolb(t)),
                  barrel_flow : (t, e, s, n, l = .84) =>
                      f(n, s, e, "x10³ BPD",
                        i.kgtolb(t) / i.BPDtolb_h(1, l) / 1e3),
                  vol_flow : (t, e, s, n) =>
                      f(n, s, e, "ft³/h", i.mtoft(t) ** 3),
                  cp : (t, e, s, n) =>
                      f(n, s, e, "Btu/lb-°F", .238845896627 * t),
                  cp_mol : (t, e, s, n) =>
                      f(n, s, e, "Btu/lb-mol-°F", .238845896627 * t),
                ...
                h = {
                  ...
                  pressure : (t, e, s, n) => f(n, s, e, "kPa", .001 * t),
                  mass : (t, e, s, n) => f(n, s, e, "kg", .001 * t),
                  mass_flow : (t, e, s, n) => f(n, s, e, "kg/h", t),
                  barrel_flow : (t, e, s, n, l = .84) =>
                      p.barrel_flow(t, e, s, n, l),
          ...
          t.exports = {
              ...
              for (c = 0; c++ < O;) {
                ...
                if (o = n - i / u, Math.abs(o - n) <= h * Math.abs(o))
                  return r || s.debug(`"Newton-Raphson", "func":"${
                                  a}", "var converged to":${o}, "iterations":${
                                  c}`),
                         o;
                n = o
              }
              return s.error(`Newton-Raphson (${
                         a}): Maximum iterations reached (${O})`),
                     !1
            },
            logger : s,
            round : c,
            ...
            normalize : _,
            flueViscosity : (t, e) => {
              const s = _(e, "flueViscosity"), n = m(t[34]), l = m(t[31]),
                    a = m(t[6]), r = m(t[3]), o = m(t[2]);
              return t => s.CO2 * a(t) + s.SO2 * n(t) + s.H2O * l(t) +
                          s.O2 * o(t) + s.N2 * r(t)
            },
            flueThermalCond : (t, e) => {
              const s = _(e, "flueThermalCond"), n = d(t[34]), l = d(t[31]),
                    a = d(t[6]), r = d(t[3]), o = d(t[2]);
              return t => s.CO2 * a(t) + s.SO2 * n(t) + s.H2O * l(t) +
                          s.O2 * o(t) + s.N2 * r(t)
            },
  ...
  (() => {
   ...
   c = s(684), {radSection : _} = s(623), {convSection : d} = s(399),
   {shieldSection : m} = s(16), {combSection : f} = s(911),
   {browserProcess : p} = s(620), h = (t, e) => {
     const s = (t => {
       const e = l.BPDtolb_h(l.lbtokg(t.mFluid), t.spGrav), s = t.tIn,
             n = t.tOut, o = t.miuFluidIn, c = t.miuFluidOut,
             _ = l.CpENtoCpSI(t.cpFluidIn), d = l.CpENtoCpSI(t.cpFluidOut),
     ...
     return s.runDistCycle && g(s),
            n.rad_result = _(s), n.shld_result = m(s), n.conv_result = d(s),
            n.rad_result.eff_thermal_val =
                n.rad_result.eff_thermal(n.conv_result.Q_stack),
            n.rad_result.eff_gcv_val =
                n.rad_result.eff_gcv(n.conv_result.Q_stack),
            n
   }, g = s => {
     let n = 0, l = !0;
     const a = {...s.NROptions};
